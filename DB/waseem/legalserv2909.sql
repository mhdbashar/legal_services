...
--
-- Host: 127.0.0.1
-- Generation Time: 29 سبتمبر 2019 الساعة 09:06
...
CREATE TABLE `tblmy_transactions` (
  ...
  `incomming_num` int(11) DEFAULT NULL,
  `incomming_source` int(11) DEFAULT NULL,
  `incomming_type` int(11) DEFAULT NULL,
...
(1, 'mhdbashard@gmail.com', 'Mhdbashar', 'Das', '', NULL, '', '', '$2a$08$JJ4pffim0G5twlrWkQPc6u0VVwlDdZPvyn4rbHz3l7uclgmHLHeyq', '2019-07-18 10:29:15', NULL, '::1', '2019-09-28 18:55:09', '2019-09-28 19:51:20', NULL, NULL, NULL, 1, NULL, 1, NULL, NULL, NULL, 0, '0.00', 0, NULL, NULL, NULL),
