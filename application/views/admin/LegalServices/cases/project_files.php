...
<?php echo form_open_multipart(admin_url('LegalServices/Cases_controller/upload_file/'.$ServID.'/'.$project->id),array('class'=>'dropzone','id'=>'project-files-upload')); ?>
      ...
      <tr>
        ...
        <td data-order="<?php echo $file['file_name']; ?>">
          ...
          <td data-order="<?php echo $file['visible_to_customer']; ?>">
            ...
            ?>
            <div class="onoffswitch">
              <input type="checkbox" data-switch-url="<?php echo admin_url(); ?>LegalServices/Cases_controller/change_file_visibility" id="<?php echo $file['id']; ?>" data-id="<?php echo $file['id']; ?>" class="onoffswitch-checkbox" value="<?php echo $file['id']; ?>" <?php echo $checked; ?>>
         ...
         <td>
           ...
           <a href="<?php echo admin_url('LegalServices/Cases_controller/remove_file/'.$ServID.'/'.$project->id.'/'.$file['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
           <?php } ?>
         </td>
       </tr>
       <?php } ?>
