                ...
                <div class="col-md-9 _buttons">
                    ...
                    <div class="pull-right">
                        ...
                        <?php if($this->app_modules->is_active('accounting')) { ?>
                            ...
                            <a onclick="convert(this)" data-toggle="tooltip" title="<?php echo _l('edit_invoice_tooltip'); ?>" class="btn btn-default btn-with-tooltip" data-placement="bottom"><?php echo _l('acc_convert') ?></a>
                        <?php } ?>
