...
<div class="modal fade" id="update_appraisal" tabindex="-1" role="dialog" aria-labelledby="update_appraisal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('hr_profile/performance/update_appraisal'),array('id'=>'form_transout')); ?>
...
<div class="modal fade" id="add_appraisal" tabindex="-1" role="dialog" aria-labelledby="add_appraisal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('hr_profile/performance/add_appraisal'),array('id'=>'form_transout')); ?>
            <div class="modal-body">
                <div class="row">
<!--                --><?php // if($this->app_modules->is_active('branches')){  ?>
<!--                    <div class="col-md-12">-->
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('hr_profile/performance/json_appraisal') ?>/" + id,
            type: "POST",
            dataType: "JSON",
