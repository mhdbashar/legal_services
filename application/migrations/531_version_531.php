...
',
        ...
        $values = [
            ...
            'message' => '
                ...
                <div style="text-align: right;"><strong><strong><br /><br /><span style="color: #376894;">المهمات التي انتهى تاريخ استحقاقها ولم ينعمل عليها مكتمل</span><br /><br /><br /><br /></strong></strong>
                <table border="1" style="height: 34px; width: 100%; background-color: #ffffff; border-color: #cbd0d4; border-style: solid;">
                <tbody>
                <tr style="height: 17px;">
