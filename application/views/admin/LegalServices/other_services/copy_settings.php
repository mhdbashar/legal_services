...
<div class="modal fade" id="copy_project" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('LegalServices/Other_services_controller/copy/'.$ServID.'/'.(isset($project) ? $project->id : '')),array('id'=>'copy_form','data-copy-url'=>admin_url('LegalServices/Cases_controller/copy/'))); ?>
