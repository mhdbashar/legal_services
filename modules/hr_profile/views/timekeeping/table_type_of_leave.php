...
//
    if(is_admin()){
        $options .= '<a id="delete-insurance" href="'. admin_url('hr_profile/delete_type_of_leave/'.$aRow['id']).'" class="btn btn-danger btn-icon _delete mleft5"><i class="fa fa-remove"></i></a>';
    }
    $row[]   = $options;
