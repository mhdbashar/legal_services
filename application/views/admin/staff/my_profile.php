                ...
                <div class="panel_s">
                    <div class="panel-body">
					   ...
					   <div class="radio radio-primary">
						...
						<label for="two_factor_email_auth_enabled"><i class="fa fa-question-circle" data-placement="right" data-toggle="tooltip" data-title="<?php echo _l('two_factor_authentication_info'); ?>"></i>
                        ...
                        <label for="two_factor_sms_auth_enabled"><i class="fa fa-question-circle" data-placement="right" data-toggle="tooltip" data-title="<?php echo _l('two_factor_sms_authentication_info'); ?>"></i>
