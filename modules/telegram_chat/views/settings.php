                        ...
                        <div class="col-md-12">
                            <form action="telegram_chat/addTelegramInfo" method="post"> 
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="bot_token" id="bot_token" value="<?php echo  is_object($userTeleInfo)?  $userTeleInfo->bot_token :'' ;?>"  placeholder="Enter telegram bot token">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="chat_id" id="chatID" value="<?php echo is_object($userTeleInfo)? $userTeleInfo->chat_id :''; ?>"  placeholder="Enter telegram chat id">
