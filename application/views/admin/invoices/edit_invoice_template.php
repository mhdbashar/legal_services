...
<div class="panel_s invoice accounting-template">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-6 hide">
                <div class="f_client_id">
                    <div class="form-group select-placeholder">
                        ...
                        <select id="clientid" readonly="readonly" name="clientid" data-live-search="true" data-width="100%" class="ajax-search<?php if(isset($invoice) && empty($invoice->clientid)){echo ' customer-removed';} ?>" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
            ...
            <?php } */?>
                ...
                if((isset($invoice) && $invoice->clientid != 0) || isset($customer_id)){
                ...
                if(!empty($legal_services)){
                    ...
                    echo render_select('rel_stype',$legal_services,array('slug','name'),'select_legal_services',$selected, ['onchange' => 'get_legal_services_by_slug()'],[], 'hide services-wrapper'.$hide_project_selector,'',true);
                    ?>
                    <div class="form-group <?php echo $hide_project_selector; ?>" id="div_rel_sid">
                        ...
                        <select class="form-control custom_select_arrow" id="rel_sid" name="rel_sid" placeholder="<?php echo _l('dropdown_non_selected_tex'); ?>">
                            ...
                            <?php
                            if(isset($invoice) && $invoice->rel_sid != 0){
                                $this->load->model('legalservices/LegalServicesModel', 'legal');
                                $slug = (isset($invoice) ? $invoice->rel_stype : '');
                                ...
                                echo '<option value="'.$invoice->rel_sid.'" selected>'.$service_name.'</option>';
                            }
                            ?>
                        </select>
                    </div>
            ...
            <div class="col-md-6">
                <div class="panel_s no-shadow">
                    ...
                    <div class="form-group mbot15 select-placeholder hide">
                    ...
                    <?php echo render_textarea('adminnote','invoice_add_edit_admin_note',$value, [], [], 'hide'); ?>

                </div>
            </div>
        </div>
    </div>
    <div class="panel-body mtop10 hide">
        <div class="row">
            <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-12 mtop15">
            <div class="panel-hide bottom-transaction">
                <?php $value = (isset($invoice) ? $invoice->clientnote : get_option('predefined_clientnote_invoice')); ?>
                <?php echo render_textarea('clientnote','invoice_add_edit_client_note',$value,array(),array(),'mtop15 hide'); ?>
                <?php $value = (isset($invoice) ? $invoice->terms : get_option('predefined_terms_invoice')); ?>
                <?php echo render_textarea('terms','terms_and_conditions',$value,array(),array(),'mtop15 hide'); ?>
