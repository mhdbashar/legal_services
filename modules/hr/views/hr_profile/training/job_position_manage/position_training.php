...
<div id="wrapper">
	<div class="content">
		<div class="row">
					...
					<div class="col-md-12">
						<div class="panel_s">
							...
							<div class="panel-body">
								...
								<?php $related = [ 
									0 => ['id' => '1', 'name' => _l('hr_basic_training')],
									2 => ['id' => '2', 'name' => _l('hr_professiona_training')],
									3 => ['id' => '3', 'name' => _l('hr_skill_training')],
									4 => ['id' => '4', 'name' => _l('hr_management_training')],
								]; ?>
								...
								<a href="<?php echo admin_url('hr/hr_profile/training?group=training_library'); ?>"  class="btn btn-default pull-right mright5 "><?php echo _l('hr_close'); ?></a>
							</div>
							<?php echo form_close(); ?>
						</div>
					</div>
							...
							<ul class="nav nav-tabs tabs-in-body-no-margin" role="tablist">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="survey_questions_tab">
										<div class="row mt-3">
											<div class="_buttons">
												<a href="<?php echo site_url('hr/participate/index/'.$position_training->training_id . '/' . $position_training->hash); ?>" target="_blank" class="btn btn-success pull-right mleft10 btn-with-tooltip" data-toggle="tooltip" data-placement="bottom" data-title="<?php echo _l('hr_survey_list_view_tooltip'); ?>"><i class="fa fa-eye"></i></a>
			...
			<?php init_tail(); ?>
			<?php 
			require('modules/hr/assets/js/training/position_training_js.php');
			?>
		</body>
	</body>
	</html>
