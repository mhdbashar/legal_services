...
<div class="modal fade" id="show_msg" tabindex="-1" role="dialog" aria-labelledby="show_msg">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('babil_sms_gateway/whatsapp/save_sms'),array('id'=>'form_transout')); ?>
...
<script>
    ...
    function show(id){
        ...
        $.ajax({
            url : "<?php echo site_url('babil_sms_gateway/whatsapp/get_sms/') ?>" + id,
            type: "POST",
            dataType: "JSON",
