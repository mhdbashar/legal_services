            ...
            <div class="col-md-12">
               <div class="pull-left">
                  ...
                  <h4 class="invoice-html-status mtop7">
                     <?php echo disputes_format_invoice_status($invoice->status,'',true); ?>
                  </h4>
               </div>
               ...
               <a href="#"
                  ...
                  <?php if (($invoice->status != Invoices_model::STATUS_PAID && $invoice->status != Invoices_model::STATUS_CANCELLED
                     && $invoice->total > 0) && disputes_found_invoice_mode($payment_modes,$invoice->id, false)){ echo ' pay-now-top'; } ?>">
      ...
      <div class="col-md-10 col-md-offset-1">
         <div class="row mtop20">
            <div class="col-md-6 col-sm-6 transaction-html-info-col-left">
               <h4 class="bold invoice-html-number"><?php echo disputes_format_invoice_number($invoice->id); ?></h4>
            ...
            <div class="col-md-12">
               <div class="row">
                  <?php
                     ...
                     if(disputes_found_invoice_mode($payment_modes,$invoice->id,false)) {
                  ...
                  <?php } ?>
                  <?php if(disputes_found_invoice_mode($payment_modes,$invoice->id)) { ?>
