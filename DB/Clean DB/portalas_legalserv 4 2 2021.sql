...
--
-- Host: localhost:3306
-- Generation Time: Feb 04, 2021 at 08:46 AM
...
(1, 'New User Added [ID: 1, Name: legal_serv]', '2021-02-02 09:52:33', 'Assesseur Admin'),
(2, 'Non Existing User Tried to Login [Email: babillawnet@gmail.com, Is Staff Member: Yes, IP: 95.216.101.150]', '2021-02-02 12:06:32', NULL);
...
(76, 'written_report', 'send_written_report_to_customer', 'english', 'Send written report to customer', '', '', '', '', 0, 1, 0),
(77, 'written_report', 'send_written_report_to_customer', 'arabic', 'إرسال تقرير مكتوب للعميل', 'تقرير مكتوب للعميل', '', '', '', 0, 1, 0),
(78, 'sessions', 'session-added-attachment-to-contacts', 'english', 'New Attachment(s) on Session (Sent to Customer Contacts)', '', '', '', NULL, 0, 1, 0),
(79, 'sessions', 'session-added-attachment-to-contacts', 'arabic', 'مرفقات جديدة في الجلسة (مرسلة إلى جهات اتصال العملاء)', '', '', '', NULL, 0, 1, 0);
INSERT INTO `tblemailtemplates` (`emailtemplateid`, `type`, `slug`, `language`, `name`, `subject`, `message`, `fromname`, `fromemail`, `plaintext`, `active`, `order`) VALUES
(80, 'sessions', 'session-added-attachment', 'english', 'New Attachment(s) on Session (Sent to Staff)', '', '', '', NULL, 0, 1, 0),
(81, 'sessions', 'session-added-attachment', 'arabic', 'مرفقات جديدة للجلسة (مرسلة لفريق العمل)', '', '', '', NULL, 0, 1, 0),
(82, 'sessions', 'session-commented-to-contacts', 'english', 'New Comment on Task (Sent to Customer Contacts)', '', '', '', NULL, 0, 1, 0),
(83, 'sessions', 'session-commented-to-contacts', 'arabic', 'تعليق جديد على الجلسة (مرسل إلى جهات اتصال العملاء)', '', '', '', NULL, 0, 1, 0),
(84, 'sessions', 'session-commented', 'english', 'New Comment on Session (Sent to Staff)', '', '', '', NULL, 0, 1, 0),
(85, 'sessions', 'session-commented', 'arabic', 'تعليق جديد على الجلسة (مرسل إلى فريق العمل)', '', '', '', NULL, 0, 1, 0),
(86, 'sessions', 'session-status-change-to-contacts', 'english', 'Session Status Changed (Sent to Customer Contacts)', '', '', '', NULL, 0, 1, 0),
(87, 'sessions', 'session-status-change-to-contacts', 'arabic', 'تغيير حالة الجلسة (مرسلة إلى جهات اتصال العملاء)', '', '', '', NULL, 0, 1, 0),
(88, 'sessions', 'session-status-change-to-staff', 'english', 'Session Status Changed (Sent to Staff)', '', '', '', NULL, 0, 1, 0),
(89, 'sessions', 'session-status-change-to-staff', 'arabic', 'تغيير حالة الجلسة (مرسلة إلى فريق العمل)', '', '', '', NULL, 0, 1, 0),
(90, 'sessions', 'send_report_session', 'arabic', 'تقرير الجلسة (مرسل إلى فريق العمل)', '', '', '', '', 0, 1, 0),
(91, 'sessions', 'send_report_session', 'english', 'Session Send Report (Sent to Staff)', '', '', '', '', 0, 1, 0),
(92, 'sessions', 'next_session_action', 'english', 'Reminder For Next Session Action', '', '', '', '', 0, 1, 0),
(93, 'sessions', 'next_session_action', 'arabic', 'تذكير بإجراءات الجلسة القادمة', '', '', '', '', 0, 1, 0);
...
(1, 'VjFab1QyVnNjRmxVYm5CaFYwWmFOVTlVYXpVeVRGUlpjVTV0UkRKTGEyY3lTMnBaY0RscGJ6SlpVV2N5V1ZSYWFFNXRRekpMWmxwb2RHMUpNbGxaUFE9PQ==', 'assesseur');
...
(1, 'قضايا', 'kd-y', 'CASE', 1, 1, 1, 0, '2021-02-02 09:47:30'),
(2, 'عقود', 'aakod', 'Akd', 1, 1, 1, 0, '2021-02-02 09:47:30'),
(3, 'استشارات', 'stsh-r-t', 'Istsh', 1, 1, 1, 0, '2021-02-02 09:47:30'),
(9, 'نزاعات مالية', 'nz_aa_t_m_ly', 'Dispute', NULL, 1, 0, 1, '2021-02-02 09:47:30');
...
(1, 'nothing_was_specified', 1, '2021-02-02');
...
(1, 'nothing_was_specified', 1, 1, '2021-02-02 09:47:26');
...
(206, 'last_email_queue_retry', '1612417201', 1),
...
(302, 'items_table_amounts_exclude_currency_symbol', '1', 1),
(303, 'round_off_task_timer_option', '0', 1),
(304, 'round_off_task_timer_time', '5', 1),
(305, 'sms_clickatell_api_key', '', 1),
(306, 'sms_clickatell_active', '0', 1),
(307, 'sms_clickatell_initialized', '1', 1),
(308, 'sms_msg91_sender_id', '', 1),
(309, 'sms_msg91_api_type', 'api', 1),
(310, 'sms_msg91_auth_key', '', 1),
(311, 'sms_msg91_active', '0', 1),
(312, 'sms_msg91_initialized', '1', 1),
(313, 'sms_twilio_account_sid', '', 1),
(314, 'sms_twilio_auth_token', '', 1),
(315, 'sms_twilio_phone_number', '', 1),
(316, 'sms_twilio_active', '0', 1),
(317, 'sms_twilio_initialized', '1', 1),
(318, 'sms_mobily_sender_id', '', 1),
(319, 'sms_mobily_api_key', '', 1),
(320, 'sms_mobily_active', '0', 1),
(321, 'sms_mobily_initialized', '1', 1),
(322, 'bitly_access_token', '', 1),
(323, 'show_services_on_calendar', '1', 1),
(324, 'calendar_service_color', '#B72974', 1),
(326, 'automatically_resend_disputes_invoice_overdue_reminder_after', '-3', 1),
(327, 'automatically_send_disputes_invoice_overdue_reminder_after', '1', 1),
(328, 'next_disputes_invoice_number', '6', 1),
(329, 'automatically_send_lawyer_daily_agenda', '7', 1),
(330, 'hr_document_reminder_notification_before', '1', 1),
(331, 'isHijri', 'on', 1),
(332, 'hijri_format', 'Y-m-d|%Y-%m-%d|hijri', 1),
(333, 'hijri_pages', '[\"Case\\/add\",\"group=CaseSession\",\"procuration\"]', 1),
(334, 'automatically_reminders_before_empty_recycle_bin_days', '1', 1),
(335, 'automatically_empty_recycle_bin_after_days', '1', 1),
(336, 'wathq_api_key', 'eaQFFTW5oOLH5a908nkCcK78Z1PQ1FAx', 1),
(339, 'paymentmethod_authorize_acceptjs_active', '0', 1),
(340, 'paymentmethod_authorize_acceptjs_label', 'Authorize.net Accept.js', 1),
(341, 'paymentmethod_authorize_acceptjs_public_key', '', 0),
(342, 'paymentmethod_authorize_acceptjs_api_login_id', '', 0),
(343, 'paymentmethod_authorize_acceptjs_api_transaction_key', '', 0),
(344, 'paymentmethod_authorize_acceptjs_description_dashboard', 'Payment for Invoice {invoice_number}', 0),
(345, 'paymentmethod_authorize_acceptjs_currencies', 'USD', 0),
(346, 'paymentmethod_authorize_acceptjs_test_mode_enabled', '0', 0),
(347, 'paymentmethod_authorize_acceptjs_default_selected', '1', 1),
(348, 'paymentmethod_authorize_acceptjs_initialized', '1', 1),
(349, 'paymentmethod_payu_money_active', '0', 1),
(350, 'paymentmethod_payu_money_label', 'PayU Money', 1),
(351, 'paymentmethod_payu_money_key', '', 0),
(352, 'paymentmethod_payu_money_salt', '', 0),
(353, 'paymentmethod_payu_money_description_dashboard', 'Payment for Invoice {invoice_number}', 0),
(354, 'paymentmethod_payu_money_currencies', 'INR', 0),
(355, 'paymentmethod_payu_money_test_mode_enabled', '1', 0),
(356, 'paymentmethod_payu_money_default_selected', '1', 1),
(357, 'paymentmethod_payu_money_initialized', '1', 1),
(358, 'paymentmethod_stripe_active', '0', 1),
(359, 'paymentmethod_stripe_label', 'Stripe Checkout', 1),
(360, 'paymentmethod_stripe_api_secret_key', '', 0),
(361, 'paymentmethod_stripe_api_publishable_key', '', 0),
(362, 'paymentmethod_stripe_description_dashboard', 'Payment for Invoice {invoice_number}', 0),
(363, 'paymentmethod_stripe_currencies', 'USD,CAD', 0),
(364, 'paymentmethod_stripe_allow_primary_contact_to_update_credit_card', '1', 0),
(365, 'paymentmethod_stripe_default_selected', '1', 1),
(366, 'paymentmethod_stripe_initialized', '1', 1),
(367, 'paymentmethod_stripe_ideal_active', '0', 1),
(368, 'paymentmethod_stripe_ideal_label', 'Stripe iDEAL', 1),
(369, 'paymentmethod_stripe_ideal_api_secret_key', '', 0),
(370, 'paymentmethod_stripe_ideal_api_publishable_key', '', 0),
(371, 'paymentmethod_stripe_ideal_description_dashboard', 'Payment for Invoice {invoice_number}', 0),
(372, 'paymentmethod_stripe_ideal_statement_descriptor', 'Payment for Invoice {invoice_number}', 0),
(373, 'paymentmethod_stripe_ideal_currencies', 'EUR', 0),
(374, 'paymentmethod_stripe_ideal_default_selected', '1', 1),
(375, 'paymentmethod_stripe_ideal_initialized', '1', 1),
(376, 'paymentmethod_instamojo_active', '0', 1),
(377, 'paymentmethod_instamojo_label', 'Instamojo', 1),
(378, 'paymentmethod_instamojo_api_key', '', 0),
(379, 'paymentmethod_instamojo_auth_token', '', 0),
(380, 'paymentmethod_instamojo_description_dashboard', 'Payment for Invoice {invoice_number}', 0),
(381, 'paymentmethod_instamojo_currencies', 'INR', 0),
(382, 'paymentmethod_instamojo_test_mode_enabled', '1', 0),
(383, 'paymentmethod_instamojo_default_selected', '1', 1),
(384, 'paymentmethod_instamojo_initialized', '1', 1),
(385, 'paymentmethod_mollie_active', '0', 1),
(386, 'paymentmethod_mollie_label', 'Mollie', 1),
(387, 'paymentmethod_mollie_api_key', '', 0),
(388, 'paymentmethod_mollie_description_dashboard', 'Payment for Invoice {invoice_number}', 0),
(389, 'paymentmethod_mollie_currencies', 'EUR', 0),
(390, 'paymentmethod_mollie_test_mode_enabled', '1', 0),
(391, 'paymentmethod_mollie_default_selected', '1', 1),
(392, 'paymentmethod_mollie_initialized', '1', 1),
(393, 'paymentmethod_paypal_braintree_active', '0', 1),
(394, 'paymentmethod_paypal_braintree_label', 'Braintree', 1),
(395, 'paymentmethod_paypal_braintree_merchant_id', '', 0),
(396, 'paymentmethod_paypal_braintree_api_public_key', '', 0),
(397, 'paymentmethod_paypal_braintree_api_private_key', '', 0),
(398, 'paymentmethod_paypal_braintree_currencies', 'USD', 0),
(399, 'paymentmethod_paypal_braintree_paypal_enabled', '1', 0),
(400, 'paymentmethod_paypal_braintree_test_mode_enabled', '1', 0),
(401, 'paymentmethod_paypal_braintree_default_selected', '1', 1),
(402, 'paymentmethod_paypal_braintree_initialized', '1', 1),
(403, 'paymentmethod_paypal_checkout_active', '0', 1),
(404, 'paymentmethod_paypal_checkout_label', 'Paypal Smart Checkout', 1),
(405, 'paymentmethod_paypal_checkout_client_id', '', 0),
(406, 'paymentmethod_paypal_checkout_secret', '', 0),
(407, 'paymentmethod_paypal_checkout_payment_description', 'Payment for Invoice {invoice_number}', 0),
(408, 'paymentmethod_paypal_checkout_currencies', 'USD,CAD,EUR', 0),
(409, 'paymentmethod_paypal_checkout_test_mode_enabled', '1', 0),
(410, 'paymentmethod_paypal_checkout_default_selected', '1', 1),
(411, 'paymentmethod_paypal_checkout_initialized', '1', 1),
(412, 'paymentmethod_paypal_active', '0', 1),
(413, 'paymentmethod_paypal_label', 'Paypal', 1),
(414, 'paymentmethod_paypal_username', '', 0),
(415, 'paymentmethod_paypal_password', '', 0),
(416, 'paymentmethod_paypal_signature', '', 0),
(417, 'paymentmethod_paypal_description_dashboard', 'Payment for Invoice {invoice_number}', 0),
(418, 'paymentmethod_paypal_currencies', 'EUR,USD', 0),
(419, 'paymentmethod_paypal_test_mode_enabled', '1', 0),
(420, 'paymentmethod_paypal_default_selected', '1', 1),
(421, 'paymentmethod_paypal_initialized', '1', 1),
(422, 'office_name_in_center', 'assesseur', 1),
(423, 'upgraded_from_version', '503', 1);
...
(1, 'admin@babillawnet.com', 'Babillawnet', 'Admin', NULL, NULL, NULL, NULL, '$2a$08$hvnH5kkk52vgut26yael1Om47Y.uU2RPFgAJ2/rUdhK7tGqZ0j5Iy', '2021-02-02 06:41:52', NULL, '95.216.101.150', '2021-02-02 12:34:53', '2021-02-02 12:37:19', NULL, NULL, NULL, 1, NULL, 1, NULL, NULL, NULL, 0, 0.00, 0, NULL, NULL, NULL, NULL);
...
(1, 'legal_serv', 'legal_serv', '$2a$08$j4Ng/fLfMxYpcKd3y5ejsunjK41K4/DAqDlTkfsY57P', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoibGVnYWxfc2VydiIsIm5hbWUiOiJsZWdhbF9zZXJ2IiwicGFzc3dvcmQiOiIiLCJBUElfVElNRSI6MTYxMjI0ODc1M30.FjV0BzhmpUqdqghUEoyy6TCA8BKla4DscMGPEuibdDc', '1970-01-01 03:00:00');
...
--
-- Table structure for table `tblwritten_reports`
--

CREATE TABLE `tblwritten_reports` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `tblwritten_reports`
--
ALTER TABLE `tblwritten_reports`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `tblemailtemplates`
  MODIFY `emailtemplateid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
-- AUTO_INCREMENT for table `tblwritten_reports`
--
ALTER TABLE `tblwritten_reports`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
