        ...
        ?>
            ...
            <div class="form-group">
                ...
                <select class="selectpicker" name="settings[appointly_available_hours][]" id="appointment_hours" data-width="100%" multiple="true">
                    <?php foreach ($appointmentHours as $hour) { ?>
                        <option value="<?php echo $hour['value']; ?>" <?php if ($savedHours !== NULL) {
            ...
            <div class="form-group">
                ...
                <select class="selectpicker" name="settings[appointly_default_feedbacks][]" id="appointly_default_feedbacks" data-width="100%" multiple="true">
                    <?php foreach ($appointmentFeedbacks as $feedback) { ?>
                        <option value="<?php echo $feedback['value']; ?>" <?php if ($savedFeedbacks !== NULL) {
            ...
            <div class="form-group">
                ...
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="y_opt_1_appointly_recaptcha"><?php echo _l('settings_yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
            ...
            <div class="form-group">
                ...
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="y_opt_1_appointly_busy_times_enabled"><?php echo _l('settings_yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
            ...
            <div class="form-group">
                ...
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="y_opt_1_appointly_also_delete_in_google_calendar"><?php echo _l('settings_yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
            ...
            <div class="form-group">
                ...
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="y_opt_1_appointments_disable_weekends"><?php echo _l('settings_yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
            ...
            <div class="form-group">
                ...
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="y_opt_1_appointly_client_meeting_approved_default"><?php echo _l('settings_yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
            ...
            <div class="form-group">
                ...
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="y_opt_1_appointments_show_past_times"><?php echo _l('settings_yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
        ...
        <?php if (staff_can('edit', 'settings')) { ?>
            <div class="form-group">
                <label for="appointly_show_clients_schedule_button" class="control-label clearfix">
                    <?php echo _l('appointly_allow_non_logged_clients_appointment'); ?>
                </label>
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="y_opt_1_appointly_show_clients_schedule_button"><?php echo _l('settings_yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
            ...
            <div class="form-group">
                <label for="appointly_tab_on_clients_page" class="control-label clearfix">
                    <?php echo _l('appointly_show_appointments_menu_item_in_clients_area'); ?>
                </label>
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="y_opt_1_appointly_tab_on_clients_page"><?php echo _l('settings_yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
        ...
        <div role="tabpanel" class="tab-pane" id="form">
            <div class="form-group mtop10">
                <label for="callbacks_mode_enabled" class="control-label clearfix">
                    <?php echo _l('callbacks_enable_on_external_form'); ?>
                </label>
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="y_opt_1_callbacks_mode_enabled"><?php echo _l('settings_yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
            ...
            <p><b>Form url:</b>
                <span class="label label-default">
                    <a href="<?php echo site_url('appointly/appointments_public/form'); ?>" target="_blank">
                        <?php echo site_url('appointly/appointments_public/form'); ?>
                    </a>
                </span>
            </p>
            <hr />
            ...
            <p>
                <span class="label label-default">
                    <a href="<?php echo site_url('appointly/appointments_public/form?col=col-md-8'); ?>" target="_blank">
                        <?php echo site_url('appointly/appointments_public/form?col=col-md-8'); ?>
                    </a>
                </span>
            </p>
            <p>
                <span class="label label-default">
                    <a href="<?php echo site_url('appointly/appointments_public/form?col=col-md-8+col-md-offset-2'); ?>" target="_blank"><?php echo site_url('appointly/appointments_public/form?col=col-md-8+col-md-offset-2'); ?></a>
                </span>
            </p>
            <p>
                <span class="label label-default">
                    <a href="<?php echo site_url('appointly/appointments_public/form?col=col-md-5'); ?>" target="_blank">
                        <?php echo site_url('appointly/appointments_public/form?col=col-md-5'); ?>
                    </a>
                </span>
            </p>
        </div>
