...
class Client_merge_fields extends App_merge_fields
{
        ...
        return [
            [
                ...
                'templates' => [
                    ...
                    'session-added-attachment-to-contacts',
                    'session-commented-to-contacts',
                    'session-status-change-to-contacts',
                    'send_report_session',
                    'next_session_action',
                    'next_session_action_to_opponent',
                ],
            ],
            [
                'name' => _l('fathername'),
                'key' => '{contact_fathername}',
                'available' => [
                    'client',
                    'ticket',
                    'invoice',
            ...
            [
                'name' => _l('grandfathername'),
                'key' => '{contact_grandfathername}',
                'available' => [
                    'client',
                    'ticket',
                    'invoice',
    ...
    public function format($client_id, $contact_id = '', $password = '')
    {
        ...
        if ($contact) {
            ...
            $fields['{contact_id_number}'] = $contact->id_number;
        ...
        $fields['{client_id_number}'] = $client->id_number;
