          ...
          <div class="col-md-6">
            <div class="select-placeholder form-group">
              ...
              <select name="approver[0]" id="approver[0]" data-id="0" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-hide-disabled="true" required="required">
                <option value=""></option>
                <option value="specific_personnel"><?php echo _l('head_of_department'); ?></option>
                <option value="specific_personnel"><?php echo _l('direct_manager'); ?></option>
    ...
    <?php foreach ($setting as $key => $value) {
      ...
      <div class="item_approve" class="row">
        <div class="col-md-11">
          <div class="col-md-6">
            <div class="select-placeholder form-group">
              ...
              <select name="approver[<?php echo html_entity_decode($key); ?>]" id="approver[<?php echo html_entity_decode($key); ?>]" data-id="<?php echo html_entity_decode($key); ?>" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-hide-disabled="true" required="required">
                <option value=""></option>
                <option value="specific_personnel" <?php if($value->approver == 'head_of_department'){ echo 'selected'; } ?>><?php echo _l('head_of_department'); ?></option>
                <option value="specific_personnel" <?php if($value->approver == 'direct_manager'){ echo 'selected'; } ?>><?php echo _l('direct_manager'); ?></option>
          ...
          <div class="col-md-6 " id="is_staff_<?php echo html_entity_decode($key); ?>">
            <div class="select-placeholder form-group">
