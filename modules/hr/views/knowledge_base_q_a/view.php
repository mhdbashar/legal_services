              ...
              <div class="panel-body">
                ...
                <?php foreach($related_articles as $rel_article_article) { ?>
                    <li>
                        ...
                        <a href="<?php echo admin_url('hr/knowledge_base_q_a/view/'.$rel_article_article['slug']); ?>" class="article-heading"><?php echo html_entity_decode($rel_article_article['subject']); ?></a>
...
<?php init_tail(); ?>
<?php  require('modules/hr/assets/js/knowledge_base_q_a/view_js.php'); ?>
