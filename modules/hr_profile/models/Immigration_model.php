...
class Immigration_model extends App_Model{

    private $table_name = 'hr_profile_immigration';
    ...
    {
        $this->deleteDirectory("uploads/hr_profile/immigration/$id");
        mkdir('uploads/hr_profile/immigration/'.$id, 0777, true);
        $config['upload_path'] = 'uploads/hr_profile/immigration/'.$id.'/';
    ...
    public function delete($id, $simpleDelete = false){
        ...
        if ($this->db->affected_rows() > 0) {
            ...
            $this->deleteDirectory("uploads/hr_profile/Immigration_model/$id");
            return true;
        } 
