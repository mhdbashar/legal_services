                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 leads-filter-column">
                            <input type="text" id="dep_tree" name="dep_tree" class="selectpicker" placeholder="<?php echo _l('filter_by'); ?>">
...
<div class="modal fade" id="department_chart_view" tabindex="-1" role="dialog">
    <div class="modal-dialog organizational_chart_dialog" style="width: 90%">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12" id="dp_chart">
                        <div id="department_chart" style="direction: ltr"></div>
                    </div>
                </div>
            </div>                 
        </div>
...
<?php init_tail(); ?>
<?php require('modules/hr/assets/js/organizational/organizational_js.php'); ?>
</body>
</html>
