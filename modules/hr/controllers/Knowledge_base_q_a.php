...
class Knowledge_base_q_a extends AdminController
{
    ...
    public function index()
    {
        ...
        if ($this->input->is_ajax_request()) {
            $this->app->get_table_data(module_views_path('hr', 'knowledge_base_q_a/kb_articles'));
        }
        ...
        if ($this->input->post()) {
            ...
            if ($id == '') {
                ...
                if ($id) {
                    ...
                    redirect(admin_url('hr/knowledge_base_q_a/article/' . $id));
                }
    ...
    public function delete_article($id)
    {
        ...
        if (!$id) {
            redirect(admin_url('hr/knowledge_base_q_a'));
        }
    ...
    public function delete_group($id)
    {
        ...
        if (!$id) {
            redirect(admin_url('hr/knowledge_base_q_a/manage_groups'));
        }
