		...
		<div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <span>Application Key is used for communication with the Application. You can change the key by clicking on the button "Generate New Key" don't forget to save it</span>
                    <p class="text-center"><button type="button" id="generate-key" class="btn btn-primary">Generate New Key</button></p>
                </div>
            </div>
