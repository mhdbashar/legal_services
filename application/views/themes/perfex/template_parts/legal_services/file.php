            ...
            <div class="row">
               <div class="col-md-8 border-right project_file_area">
                  ...
                  if ($ServID == 1){
                      ...
                      $path = OSERVICE_ATTACHMENTS_FOLDER .$file->project_id.'/'.$file->file_name;
                      $url_text = 'oservices';
                  }
                     if(is_image($path)){ ?>
                  <img src="<?php echo base_url('uploads/'.$url_text.'/'.$file->project_id.'/'.$file->file_name); ?>" class="img img-responsive">
                  ...
                  <iframe src="<?php echo base_url('uploads/'.$url_text.'/'.$file->project_id.'/'.$file->file_name); ?>" height="100%" width="100%" frameborder="0"></iframe>
                  ...
                  <?php } else if(is_markdown_file($path) && $previewMarkdown = markdown_parse_preview($path)) {
                     ...
                     if(empty($file->external)) {
                        echo '<a href="'.site_url('uploads/'.$url_text.'/'.$file->project_id.'/'.$file->file_name).'" download>'.$file->file_name.'</a>';
                     } else {
