...
class Prchat_Controller extends AdminController
{
    ...
    public function __construct()
    {
        ...
        if (
            ...
            echo '<h4>Setup Pusher now: <a href="' . site_url('admin/settings?group=pusher') . '">Babil Settings->Pusher.com</a></h4>';
            echo '<h4>Tutorial: <a target="blank" href="https://tl4t.com/">See example how to setup Pusher from Babil documentation</a>';
            die;
        }
    ...
    public function convertToTicket()
    {
        ...
        $data = [
            'id' => $id,
            'user_full_name' => $name,
            'messages' => json_encode($this->chat_model->getMessagesForTicketConversion($id, $table)),
        ];
    ...
    /** 
     * Handles new ticket support creation view
     */
