...
<div class="modal fade" id="mark_tasks_finished_modal" tabindex="-1" role="dialog" data-toggle="modal">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-footer">
        <button class="btn btn-info" id="project_mark_status_confirm" onclick="confirm_case_status_change(this, '<?php echo $slug ?>'); return false;"><?php echo _l('project_mark_tasks_finished_confirm'); ?></button>
    </div>
</div>
</div>
</div>
