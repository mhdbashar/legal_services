...
class Hr_tabs
{
    ...
    public function add_employeedetails_tab($slug, $tab)
    {
        $this->add($slug, $tab, 'employeedetails');

        return $this;
    }

    public function add_employeedetails_tab_children_item($parent_slug, $tab)
    {
        $this->add_child($parent_slug, $tab, 'employeedetails');

        return $this;
    }

    public function get_employeedetails_tabs()
    {
        return $this->get('employeedetails');
    }
