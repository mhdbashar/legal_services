                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="edit_kb_group(this,<?php echo html_entity_decode($group['groupid']); ?>); return false" data-name="<?php echo html_entity_decode($group['name']); ?>" data-color="<?php echo html_entity_decode($group['color']); ?>" data-description="<?php echo clear_textarea_breaks($group['description']); ?>" data-order="<?php echo html_entity_decode($group['group_order']); ?>" data-active="<?php echo html_entity_decode($group['active']); ?>" data-slug="<?php echo html_entity_decode($group['group_slug']); ?>" class="btn btn-default btn-icon"><i class="fa fa-pencil-square-o"></i></a>
                                        <?php } ?>
