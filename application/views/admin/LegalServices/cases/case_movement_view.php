...
<div class="activity-feed">
    ...
    foreach ($movements as $movement) { ?>
        <div class="feed-item">
            <div class="row">
                <div class="col-md-8">
                    <div class="date"><span class="text-has-action" data-toggle="tooltip" data-title="<?php echo $movement['inserted_date']; ?>"><?php echo time_ago($movement['project_created']); ?></span>
                    </div>
                    <div class="text">
