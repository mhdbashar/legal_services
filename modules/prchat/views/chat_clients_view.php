...
<div id="clientChat">
    <div class="firstDiv">
        ...
        <div class="clientwrapper">
            <div class="m-area" data-staffid="" onscroll="loadMessages(this)">
...
<script>
    ...
    $("body").on('click', clientsArea, function(e) {
        checkForUnread();
    });

    function checkForUnread(staff = '') {
        var staff_id = $('.m-area').attr('data-staffid');
        ($('.staff_children_parent_child_div.active_staff').prev().is(':visible')) ? updateUnreadNotifications(staff_id): '';
    }
    ...
    clientsArea.on('keypress', function(e) {
        ...
        if (e.which == 13) {
            ...
            messageToAppend = '';
            messageToAppend += '<li class="client">'
    ...
    // Function that handles contacts messages prepending
    function prependContactMessages(value) {
        ...
        if (value.reciever_id == contact_name_id) {
            ...
            messageContainer += '<li class="client">';
            messageContainer += msgDiv;
