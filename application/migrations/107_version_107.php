...
class Migration_Version_107 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if (file_exists(APPPATH . 'views/themes/babil/template_parts/contract_attachments.php')) {
            @unlink(APPPATH . 'views/themes/babil/template_parts/contract_attachments.php');
        }
