...
<?php init_head(); ?>
                        ...
                        <div class="panel-body">
                            ...
                            if (has_permission('attendance_management', '', 'view') || is_admin()) {
                                ...
                                <div class="row filter_by">
                                    ...
                                    <div class="col-md-1 mtop25">
                                        <button type="button"
                                                class="btn btn-info timesheets_filter"><?php echo _l('filter'); ?></button>
                                    </div>
                                </div>
                            <?php } ?>
                            <?php echo form_open(admin_url('hr_profile/manage_timesheets'), array('id' => 'timesheets-form')); ?>
                            ...
                            <div class="row mtop15">
                                <div class="col-md-8 line-suggestion">
                                    ...
                                    <br>
                                    <?php foreach ($type_of_leave as $type) { ?>
                                        <button type="button" data-toggle="tooltip" data-placement="top"
                                                data-original-title="<?php echo $type->name ;echo ' ';echo  _l('Number_of_leaving_day') ;echo ' ';echo $type->number_of_days?>"
                                                class="btn"><?php echo $type->code ?></button>
                                    <?php } ?>
                                ...
                                <div class="col-md-4">
                                    <a href="javascript:void(0)"
                                       class="btn btn-default pull-right mtop5 mleft10 export_excel">
                                    ...
                                    <?php if ($data_timekeeping_form == 'timekeeping_manually') { ?>
                                        <button type="button" onclick="open_check_in_out();"
                                                class="btn btn-info pull-right display-block mtop5 check_in_out_timesheet"
                                                data-toggle="tooltip" title=""
                                                data-original-title="<?php echo _l('check_in') . ' / ' . _l('check_out'); ?>"><?php echo _l('check_in'); ?>
                                            / <?php echo _l('check_out'); ?></button>
                                    <?php } elseif ($data_timekeeping_form == 'csv_clsx') { ?>
                                        <button type="button"
                                                class="btn btn-info pull-right display-block mtop5 check_in_out_timesheet"
                                                data-toggle="modal" data-target="#import_timesheets_modal"
                                                data-original-title="<?php echo _l('import_timesheets'); ?>"><?php echo _l('import_timesheets'); ?></button>
                                    <?php } ?>
                                </div>
                                <div class="clearfix"></div>
                                <br>
                                <div class="col-md-12">
                                    ...
                                    <?php if (is_admin() || has_permission('timesheets_timekeeping', '', 'edit')) { ?>
                                        ...
                                        <button class="btn btn-danger pull-right unlatch_time_sheet mleft5 <?php echo html_entity_decode($latched); ?>"
                                                id="btn_unlatch"
                                                onclick="return confirm('<?php echo _l('timekeeping_unlatch'); ?>')"><?php echo _l('reopen_attendance'); ?></button>

                                        <button class="btn btn-info pull-right latch_time_sheet mleft5 <?php echo html_entity_decode($latch); ?>"
                                                id="btn_latch"
                                                onclick="return confirm('<?php echo _l('timekeeping_latch'); ?>')"><?php echo _l('close_attendance'); ?></button>
    ...
    <div class="modal fade" id="import_timesheets_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <?php echo form_open_multipart(admin_url('hr_profile/import_timesheets'), array('id' => 'import-timesheets-form')); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                            data-dismiss="modal"><?php echo _l('close'); ?></button>
                    <a href="<?php echo site_url('modules/hr_profile/uploads/timesheets/import_timesheets.xlsx'); ?>"
                       class="btn btn-primary"><?php echo _l('download_sample'); ?></a>
