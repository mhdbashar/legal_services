					...
					<div class="panel-body">
						...
						<?php echo form_open($this->uri->uri_string());?>
							...
							<div class="setting-color">
								<label>
									<input type="radio" name="staff_theme" value="<?php echo ($theme['id'])?>" <?php if($selected_theme == $theme['id']) echo 'checked';?>>
...
<?php init_tail(); ?>
<script>
$('input[name="staff_theme"]').on('change', function() {
	$.post(admin_url + 'si_custom_theme/staff_theme/get_theme', {
		theme:$('input[name="staff_theme"]:checked').val(),
