            ...
            $data=$this->ProposalInvoice_model->get_proposalinvoice($staff_id,$type,$invoiceid,$ispaid);
                ...
                foreach ($data as $datas) {
                    ...
                    $datas->Invoice_name = $this->ProposalInvoice_model->get_Invoice_name($datas->invoiceid);
                      $datas->TotalAmount = $this->ProposalInvoice_model->get_TotalAmount($datas->invoiceid);
                      $datas->duepay=(string) ($datas->TotalAmount -   $datas->invoicepayment);
                }else{
                    $datas->Invoice_name = $this->ProposalInvoice_model->get_Company_name($datas->clientid);
                }
