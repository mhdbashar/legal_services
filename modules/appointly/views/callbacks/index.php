                    ...
                    <div class="panel-body">
                        <div class="_buttons">
                            <a data-toggle="tooltip"
                               title="<?= _l('appointly_back_to_appointments'); ?>"
                               href="<?= admin_url('appointly/appointments'); ?>"
                               id="backToAppointments"
                            ...
                            <div class="btn-group pull-right btn-with-tooltip-group _filter_data"
                                ...
                                <ul class="dropdown-menu dropdown-menu-left width300 height500">
                                    <li class="filter-group active">
                                        <a href="#"
                                           data-cview="all"
                                           onclick="dt_custom_view('','.table-callbacks',''); return false;">
                                            <?php echo _l('all'); ?>
                                        </a>
                                    </li>
                                    <li class="divider"></li>
                                    ...
                                    foreach (getCallbacksTableStatuses() as $status)
                                    {
                                        ...
                                        <li class="filter-group"
                                            ...
                                            <a href="#"
                                               data-cview="<?= $status; ?>"
                                               onclick="dt_custom_view('<?= $status; ?>','.table-callbacks'); return false;">
