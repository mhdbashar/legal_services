...
?>
    <div class="col-md-3">
        <div class="cardbox text-center">
            ...
            <textarea style="display: none;" id="m_map_<?php echo $aRow['id'];?>"><?php echo ($aRow['mindmap_content']);?></textarea>
            <div class="map_grid" id="map_<?php echo $aRow['id'];?>"><img src="<?php echo site_url() ?>/modules/mindmap/assets/images/loader.gif"></div>
            <h4><a href="<?php echo admin_url('mindmap/preview/' . $aRow['id']);?>"><?php echo $aRow['title'];?></a><?php ?></h4>
