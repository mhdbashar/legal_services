                    ...
                    <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <label for="name_contract" class="control-label"><?php echo _l('name_contract'); ?></label>
                          <select name="name_contract" required="required" class="selectpicker" id="name_contract" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                             <option></option>
