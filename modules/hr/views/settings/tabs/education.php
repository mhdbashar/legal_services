    	 ...
    	 <?php $this->load->view('settings/modals/education_type_modal') ?>
				<?php if (has_permission('hr', '', 'create')){ ?><a href="#" class="btn btn-info pull-left" data-toggle="modal" data-target="#add_education_type"><?php echo _l('add_education_type'); ?></a><?php } ?>
