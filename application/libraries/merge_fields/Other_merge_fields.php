...
class Other_merge_fields extends App_merge_fields
{
    public function build()
    {
        ...
        return [
            ...
            [
                'name' => _l('commercial_register'),
                'key' => '{commercial_register}',
                'fromoptions' => true,
                'available' => $available_for,
            ],
            [
                'name' => _l('other_number'),
                'key' => '{other_number}',
                'fromoptions' => true,
                'available' => $available_for,
            ],
    ...
    public function format()
    {
        ...
        $fields['{commercial_register}'] = get_option('invoice_company_commercial_register');
        $fields['{other_number}'] = get_option('other_number');
