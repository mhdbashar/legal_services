                  ...
                  <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
					 ...
					 <?php if(total_rows(db_prefix().'emailtemplates',array('slug'=>'two-factor-authentication','active'=>0)) == 0){ ?>
					   ...
					   <div class="radio radio-primary">
						...
						<br>
						<input type="radio" value="1" name="two_factor_auth_enabled" id="two_factor_email_auth_enabled"<?php if(isset($member) && $member->two_factor_auth_enabled == 1){echo ' checked';} ?>>
						<label for="two_factor_email_auth_enabled"><i class="fa fa-question-circle" data-toggle="tooltip" data-title="<?php echo _l('two_factor_authentication_info'); ?>"></i>
                        <?php echo _l('enable_two_factor_authentication'); ?></label>
						<br>
						<input type="radio" value="2" name="two_factor_auth_enabled" id="two_factor_sms_auth_enabled"<?php if(isset($member) && $member->two_factor_auth_enabled == 2){echo ' checked';} ?>>
                        <label for="two_factor_sms_auth_enabled"><i class="fa fa-question-circle" data-toggle="tooltip" data-title="<?php echo _l('two_factor_sms_authentication_info'); ?>"></i>
...
<!--                     --><?php //} */ ?>
      ...
      <div class="col-md-7 small-table-right-col">
         ...
         <div class="panel_s">
            <div class="panel-body">
               <h4 class="no-margin">
                  <?php echo _l('task_timesheets'); ?> & <?php echo _l('als_reports'); ?> / <?php echo _l('tasks'); ?>
               </h4>
               <hr class="hr-panel-heading" />
               ...
               <table class="table dt-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <?php
                              if(isset($t['rel_type']) && $t['rel_type'] != '' || isset($t['rel_id']) && $t['rel_id'] != ''){
          ...
          <div class="panel_s">
              <div class="panel-body">
                  <h4 class="no-margin">
                      <?php echo _l('task_timesheets'); ?> & <?php echo _l('als_reports'); ?> / <?php echo _l('sessions'); ?>
                  </h4>
                  <hr class="hr-panel-heading" />
                  <?php echo form_open($this->uri->uri_string(),array('method'=>'GET')); ?>
                  <?php echo form_hidden('filter','true'); ?>
                  ...
                  <table class="table dt-table scroll-responsive">
                      ...
                      <?php
                      $total_logged_time = 0;
                      foreach($sessions_timesheets as $t){ ?>
                          <tr>
                              <td><a href="#" onclick="init_session_modal(<?php echo $t['task_id']; ?>); return false;"><?php echo $t['name']; ?></a></td>
                              <td data-order="<?php echo $t['start_time']; ?>"><?php echo _dt($t['start_time'], true); ?></td>
                              <td data-order="<?php echo $t['end_time']; ?>">
                                  <?php
                                  // Allow admins or timer user to stop forgotten timers by staff member
                                  if($t['not_finished'] && (is_admin() || $t['staff_id'] === get_staff_user_id())) {
                                      ...
                                      <a href="#"
                                          ...
                                          if($t['task_id'] != 0){ ?>
                                              ...
                                              data-title="<?php echo _l('note'); ?>"
                                              data-content='<?php echo render_textarea('timesheet_note'); ?><button type="button"
                                          onclick="timer_session_action(this, <?php echo $t['task_id']; ?>, <?php echo $t['id']; ?>, 1);" class="btn btn-info btn-xs"><?php echo _l('save'); ?></button>'
                                              onclick="return false;"
                                          <?php } else { ?>
                                              onclick="timer_session_action(this, <?php echo $t['task_id']; ?>, <?php echo $t['id']; ?>, 1); return false;"
                                          <?php } ?>
                                         class="text-danger"
                                      >
                                          <i class="fa fa-clock-o"></i>
          ...
          <div class="panel_s">
              <div class="panel-body">
                  ...
                  <?php render_datatable(array(
                      ...
                      _l('project_deadline'),
                      _l('project_status'),
                  ),'staff-disputes-cases'); ?>
              </div>
          </div>
          <div class="panel_s">
              <div class="panel-body">
                  <h4 class="no-margin">
                      <?php echo _l('LegalServices'); ?>
                  </h4>
                  <hr class="hr-panel-heading" />
                  <div class="_filters _hidden_inputs hidden staff_projects_filter">
                      <?php echo form_hidden('staff_id',$member->staffid); ?>
