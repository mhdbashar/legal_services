      ...
      <div class="col-md-12">
            <div class="panel_s">
              ...
              <?php if(has_permission('projects','','create')){ ?>
                <a href="<?php echo admin_url('disputes/project'); ?>" class="btn btn-info pull-left display-block mright5">
...
$(function(){
     ...
     initDataTable('.table-projects', 'disputes/table', undefined, undefined, ProjectsServerParams, <?php echo hooks()->apply_filters('projects_table_default_order', json_encode(array(5,'asc'))); ?>);
