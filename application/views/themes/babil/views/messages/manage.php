		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel_s">
                    ...
                    <?php if (has_permission('messages_manage', '', 'create')) { ?>
						<div  style="padding: 10px;">							
							<a style="margin-left:5px ;" href="<?php echo admin_url('Messages/messagescu'); ?>" class="btn btn-info pull-left  new"><?php echo _l('رسالة جديدة'); ?></a>
