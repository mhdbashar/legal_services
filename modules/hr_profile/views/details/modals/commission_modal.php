...
<div class="modal fade" id="update_commission" tabindex="-1" role="dialog" aria-labelledby="update_commission" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr_profile/update_commission'),array('id'=>'form_transout')); ?>
...
<div class="modal fade" id="add_commission" tabindex="-1" role="dialog" aria-labelledby="add_commission" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr_profile/add_commission'),array('id'=>'form_transout')); ?>
            <?php echo form_hidden('staff_id', $staff_id); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('hr_profile/json_commission') ?>/" + id,
            type: "POST",
            dataType: "JSON",
