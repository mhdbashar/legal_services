            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <table class="table no-margin project-overview-table">
                        ...
                        <?php $i = 1;
                        foreach ($project->opponent_data as $opponent){
                        ...
                        <?php if(isset($project) && $project->opponent_lawyer_id != 0){
                            $opponent_lawyer = get_opponent_lawyer_by_id($project->opponent_lawyer_id)?>
                            <tr class="project-overview-customer">
                        ...
                        <tr class="project-overview-customer">
                            ...
                            <td><?php echo app_format_money($project->disputes_total,$currency); ?></td>
                        </tr>
                        ...
                        <tr class="project-overview-start-date">
                            ...
                            <td>
                                ...
                                <?php if($CI->app_modules->is_active('hijri')){ ?>
                                    <br>
                                    <?php echo  _d(to_hijri_date($project->start_date)); ?>
                                <?php } ?>
                        ...
                        <?php if($project->deadline){ ?>
                            <tr class="project-overview-deadline">
                                ...
                                <td><?php echo _d($project->deadline); ?>
                                    ...
                                    <?php if($CI->app_modules->is_active('hijri')){ ?>
                                        <br>
                                        <?php echo  _d(to_hijri_date($project->deadline)); ?>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
                ...
                <div class="col-md-6">
                    <table class="table no-margin project-overview-table">
                        ...
                        <?php if(isset($project) && $project->childsubcat_id != 0){?>
                        <tr class="project-overview-customer">
                        ...
                        <?php if(isset($project->case_status) && $project->case_status != 0){
                            $case_status = get_disputes_status_by_id($project->case_status);?>
                        <tr class="project-overview-customer">
                            <td class="bold"><?php echo _l('disputes_cases_status'); ?></td>
                            <td><?php echo $case_status->status_name;?></td>
                        </tr>
                        <?php }?>
<!--                        <tr class="project-overview-customer">-->
...
<!--                        </tr>-->
                ...
                foreach($members as $member){ ?>
                    <div class="media">
                        ...
                        <div class="media-body">
                            <?php if(has_permission('projects','','edit')){ ?>
                                <a href="<?php echo admin_url('legalservices/disputes_cases/remove_team_member/'.$ServID.'/'.$project->id.'/'.$member['staff_id']); ?>" class="pull-right text-danger _delete"><i class="fa fa fa-times"></i></a>
                            <?php } ?>
            ...
            <div class="project-overview-timesheets-chart">
                ...
                <div class="dropdown pull-right">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuProjectLoggedTime">
                        <li><a href="<?php echo admin_url('legalservices/disputes_cases/view/'.$ServID.'/'.$project->id.'?group=project_overview&overview_chart=this_week'); ?>"><?php echo _l('this_week'); ?></a></li>
                        <li><a href="<?php echo admin_url('legalservices/disputes_cases/view/'.$ServID.'/'.$project->id.'?group=project_overview&overview_chart=last_week'); ?>"><?php echo _l('last_week'); ?></a></li>
                        <li><a href="<?php echo admin_url('legalservices/disputes_cases/view/'.$ServID.'/'.$project->id.'?group=project_overview&overview_chart=this_month'); ?>"><?php echo _l('this_month'); ?></a></li>
                        <li><a href="<?php echo admin_url('legalservices/disputes_cases/view/'.$ServID.'/'.$project->id.'?group=project_overview&overview_chart=last_month'); ?>"><?php echo _l('last_month'); ?></a></li>
                    </ul>
                </div>
                <div class="clearfix"></div>
    ...
    <div class="modal fade" id="add-edit-members" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <?php echo form_open(admin_url('legalservices/disputes_cases/add_edit_members/'.$ServID. '/' .$project->id)); ?>
