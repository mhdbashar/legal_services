...
/*
Module Name: إدارة حالات المهام والخدمات
Description: إضافة لإضافة وتعديل حالات المهام والخدمات القانونية
Version: 1.1.0
Author: Babil Team
...
function load_project_statuses_from_db($statuses)
{
    ...
    if (!isset($CI->project_status_once) && isset($CI->uri->segments[3], $CI->uri->segments[4]) && ($CI->uri->segments[3] == 'project' || $CI->uri->segments[3] == 'view') && is_numeric($CI->uri->segments[4])) {
