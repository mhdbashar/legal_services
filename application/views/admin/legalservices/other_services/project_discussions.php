...
<?php if(!isset($discussion)){ ?>
    ...
    ),'oservice-discussions', [] ,$table_attributes); ?>
<?php } else { ?>
    ...
    <p><?php echo _l('project_discussion_total_comments'); ?>: <?php echo total_rows(db_prefix().'oservicediscussioncomments',array('discussion_id'=>$discussion->id, 'discussion_type'=>'regular')); ?></p>
