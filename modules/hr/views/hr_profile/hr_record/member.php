				...
				<div class="col-md-3">
					...
					<ul class="nav navbar-pills navbar-pills-flat nav-tabs nav-stacked">
						...
						foreach($tab as $group_item){
							...
							<a href="<?php echo admin_url('hr/hr_profile/member/'.$staffid.'/'.$group_item); ?>" data-group="<?php echo html_entity_decode($group_item); ?>">
								<?php
								...
								if($group_item == 'profile'){
									...
									echo html_entity_decode($icon['other'] .' '. _l($group_item)); 
								}
								?>
							</a>
						</li>
