                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <h4 class="bold well email-template-heading">
                                    <?php echo _l('email_template_procuration_fields_heading'); ?>
                                    <?php if($hasPermissionEdit){ ?>
                                        <a href="<?php echo admin_url('emails/disable_by_type/procuration'); ?>" class="pull-right mleft5 mright25"><small><?php echo _l('disable_all'); ?></small></a>
                                        <a href="<?php echo admin_url('emails/enable_by_type/procuration'); ?>" class="pull-right"><small><?php echo _l('enable_all'); ?></small></a>
                                    <?php } ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <?php foreach($procuration as $rd_template){ ?>
                                            <tr>
                                                <td class="<?php if($rd_template['active'] == 0){echo 'text-throught';} ?>">
