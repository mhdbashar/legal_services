...
if (!is_dir(BABIL_CHAT_MODULE_UPLOAD_FOLDER)) {
  mkdir(BABIL_CHAT_MODULE_UPLOAD_FOLDER, 0755);
  $fp = fopen(BABIL_CHAT_MODULE_UPLOAD_FOLDER . '/index.html', 'w');
  fclose($fp);
}

if (!is_dir(BABIL_CHAT_MODULE_GROUPS_UPLOAD_FOLDER)) {
  mkdir(BABIL_CHAT_MODULE_GROUPS_UPLOAD_FOLDER, 0755);
  $fp = fopen(BABIL_CHAT_MODULE_GROUPS_UPLOAD_FOLDER . '/index.html', 'w');
  fclose($fp);
}

if (!is_dir(BABIL_CHAT_MODULE_AUDIO_UPLOAD_FOLDER)) {
  mkdir(BABIL_CHAT_MODULE_AUDIO_UPLOAD_FOLDER, 0755);
  $fp = fopen(BABIL_CHAT_MODULE_AUDIO_UPLOAD_FOLDER . '/index.html', 'w');
  fclose($fp);
}
