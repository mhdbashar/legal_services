...
foreach ($rResult as $aRow) {
    ...
    $row[] = '<a href="/admin/hr_profile/insurance"> ' . staff_profile_image($aRow[db_prefix().'staff_insurance.staff_id'], [
                'staff-profile-image-small',
                ]) . '</a><a href='.admin_url('hr_profile/insurance/'). $aRow['id'] .'> ' . $aRow['firstname'] . ' ' . $aRow['lastname'] . '</a>';
