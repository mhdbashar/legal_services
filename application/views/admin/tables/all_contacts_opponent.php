...
$aColumns        = [ 'CONCAT(firstname, \' \',fathername, \' \',grandfathername, \' \', lastname) as full_name'];
...
$join[] = 'INNER JOIN '.db_prefix().'clients ON '.db_prefix().'clients.userid='.db_prefix().'contacts.userid AND '.db_prefix().'clients.client_type = 1';
