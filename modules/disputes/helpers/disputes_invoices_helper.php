...
//    $CI->db->select('amount')
//    ->where('invoiceid', $id)
//    ->order_by(db_prefix() . 'tblmy_disputes_cases_invoicepaymentrecords.id', 'asc');
//    $payments = $CI->db->get(db_prefix() . 'tblmy_disputes_cases_invoicepaymentrecords')->result_array();
//
//    if (!class_exists('credit_notes_model')) {
//        $CI->load->model('credit_notes_model');
//    }
