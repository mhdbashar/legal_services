 ...
 * @category        Controller 
 */
class Service2 extends REST_Controller {
    ...
    public function data_get($id = '')
    {
        ...
        $data = $this->Api_model->get_table('Service2', $id);
    ...
    {
        $data = $this->Api_model->search('Service2', $key);
    ...
    public function data_post()
    {
            ...
            else
            {
                ...
                $output = $this->other->add(2, $insert_data);                
