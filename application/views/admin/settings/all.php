...
<div id="wrapper">
    <div class="content">
        ...
        echo form_open_multipart(
                (!isset($tab['update_url']) ? $this->uri->uri_string() . '?group=' . $tab['slug'] . ($this->input->get('tab') ? '&active_tab=' . $this->input->get('tab') : '') : $tab['update_url']), ['id' => 'settings-form', 'class' => isset($tab['update_url']) ? 'custom-update-url' : '']
        );
        ?>
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <a href="<?php echo admin_url('settings?group=update'); ?>" class="<?php
                        if ($this->input->get('group') == 'update') {
                            echo 'bold';
                        }
                        ?>">
                        ...
                        <!-- <?php if (is_admin()) {
                                   ?>
                                      <hr class="hr-10" />
                                      <a href="<?php echo admin_url('settings?group=info'); ?>" class="<?php
                            if ($this->input->get('group') == 'info') {
                                echo 'bold';
                            }
                            ?>">
                                        System/Server Info
                        ...
                        <?php if (is_admin()) {
                            ?>
                            <hr class="hr-10" />
                            <a href="<?php echo admin_url('settings?group=license'); ?>" class="<?php
                            if ($this->input->get('group') == 'license') {
                                echo 'bold';
                            }
                            ?>">
                        ...
                        <div class="btn-bottom-toolbar text-right">
                            ...
                            <button type="submit" class="btn btn-info" id="submit_office_name">
