...
<div class="col-md-12 no-padding animated fadeIn">
    <div class="panel_s">
        <?php echo form_open(admin_url('legalservices/disputes_invoices/record_payment'),array('id'=>'record_payment_form')); ?>
        <?php echo form_hidden('invoiceid',$invoice->id); ?>
        <div class="panel-body">
            <h4 class="no-margin"><?php echo _l('record_payment_for_invoice'); ?> <?php echo disputes_format_invoice_number($invoice->id); ?></h4>
           <hr class="hr-panel-heading" />
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="selectpicker" name="paymentmode" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                            ...
                            <?php
                            if(disputes_is_payment_mode_allowed_for_invoice($mode['id'],$invoice->id)){
                                $totalAllowed++;
                            ?>
                    ...
                    if($totalAllowed === 0) {
                        ...
                        <div class="alert alert-info">
                            ...
                            Click <a href="<?php echo admin_url('legalservices/disputes_invoices/invoice/'.$invoice->id.'?allowed_payment_modes=1'); ?>">here</a> to edit the invoice and allow payment modes.
                        </div>
                        <?php
                    }
            ...
            <div class="pull-right mtop15">
                <a href="#" class="btn btn-danger" onclick="init_invoice_disputes(<?php echo $invoice->id; ?>); return false;"><?php echo _l('cancel'); ?></a>
