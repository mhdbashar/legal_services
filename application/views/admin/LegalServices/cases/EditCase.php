                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="court_id" onchange="GetCourtJad()" name="court_id" placeholder="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                        <option selected disabled></option>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="jud_num" name="jud_num" placeholder="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                        <option selected disabled></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php echo render_date_input('start_date','project_start_date',$case->start_date); ?>
                            </div>
                            <div class="col-md-6">
                                <?php echo render_date_input('deadline','project_deadline',$case->deadline); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
