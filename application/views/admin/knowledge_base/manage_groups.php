                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(has_permission('knowledge_base','','edit')){ ?>
                                                    <a href="#" onclick="edit_kb_group(this,<?php echo $group['groupid']; ?>); return false" data-name="<?php echo $group['name']; ?>" data-parent_id="<?php echo $group['parent_id']; ?>" data-color="<?php echo $group['color']; ?>" data-description="<?php echo clear_textarea_breaks($group['description']); ?>" data-order="<?php echo $group['group_order']; ?>" data-active="<?php echo $group['active']; ?>" data-is_main="<?php echo $group['is_main']; ?>" data-slug="<?php echo $group['group_slug']; ?>" class="btn btn-default btn-icon"><i class="fa fa-pencil-square-o"></i></a>
                                                <?php } ?>
