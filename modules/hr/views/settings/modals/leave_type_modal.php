...
<div class="modal fade" id="update_type" tabindex="-1" role="dialog" aria-labelledby="update_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr/setting/update_leave_type'),array('id'=>'form_transout', 'method'=>'get')); ?>
            <?php echo form_hidden('id'); ?>
            
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo render_input('name',_l('leave'),'','text'); ?>
                    </div>
                    <div class="col-md-12">
                        <?php echo render_input('days',_l('number_of_days'),'','number'); ?>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="add_leave_type" tabindex="-1" role="dialog" aria-labelledby="add_leave_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button group="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <?php echo form_open(admin_url('hr/setting/add_leave_type'),array('id'=>'form_transout', 'method'=>'get')); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo render_input('name',_l('leave'),'','text'); ?>
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('hr/setting/leave_type_json') ?>/" + id,
            type: "POST",
            dataType: "JSON",
