...
?>
                                ...
                                <div class="form-group green-border-focus">
                                    ...
                                    <textarea rows="5" cols="150" readonly class="form-control"
...
if (isset($message_info->files) && ($message_info->files !== null)) {
    ...
    ?>
                                <br>
                                <a target="_blank"
                                    href='<?php echo site_url(protected_file_url_by_path($path) . $message_info->id . '/' . $message_info->files) ?>'>
    ...
    foreach ($reply_messages as $reply) {
        ...
        ?>
                                ...
                                <div class="form-outline">
                                    <textarea readonly class="form-control" id="textAreaExample1"
                                        rows="4"><?php echo $reply->message; ?></textarea>
        ...
        ?>
                                <br>
                                <a target="_blank"
                                    href='<?php echo site_url(protected_file_url_by_path($path) . $reply->id . '/' . $reply->files) ?>'><?php echo $reply->files; ?></a>
                                ...
                                <div id="formmessage">
                                    ...
                                    <form id="reply_message" action="" enctype="multipart/form-data">
                                        <input type="hidden" name="from_user_id"
                                            value="<?php echo get_staff_user_id() ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="profile_image"
                                                class="profile-image"><?php echo _l('attachment'); ?></label>
                                            <input type="file" name="files" class="form-control" id="files">
                                        </div>

                                        <button type="submit"
                                            class="btn btn-info pull-right"><?php echo _l('رد على الرسالة'); ?></button>
    ...
    $('#reply_message').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                html +=
                    '<textarea rows="5" cols="150" readonly class="form-control tinymce" id="exampleFormControlTextarea5" rows="3">';
