...
<script>
    $(function(){
        ...
        initDataTable('.table-hr-contracts', admin_url+'hr/contracts/table', undefined, undefined, ContractsServerParams,<?php echo hooks()->apply_filters('hr_contracts_table_default_order', json_encode(array(6,'asc'))); ?>);
