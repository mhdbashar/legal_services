...
$where = ['AND task_id IN (SELECT id FROM ' . db_prefix() . 'tasks WHERE rel_id="' . $project_id . '" AND rel_type="'.$slug.'")'];
...
$staff_ids = $this->ci->other->get_distinct_tasks_timesheets_staff($project_id, $slug);
