                ...
                <div class="row">
                    <div class="col-md-12 border-right project_file_area">
                        ...
                        <?php } else if(strpos($file->filetype,'docs') !== false || strpos($file->filetype,'doc') !== false || strpos($file->filetype,'docx') !== false && empty($file->external)){ ?>
                            <iframe src="<?php echo 'https://docs.google.com/viewer?url=' . base_url('uploads/oservices/'.$file->oservice_id.'/'.$file->file_name) . '&embedded=true'; ?>" height="100%" width="100%" frameborder="0"></iframe>
                        ...
                        <?php } else if(is_markdown_file($path) && $previewMarkdown = markdown_parse_preview($path)) {
                            ...
                            if(empty($file->external)) {
                                echo '<a href="' . site_url('uploads/oservices/' . $file->project_id . '/' . $file->file_name) . '" download="' .  $file->original_file_name . '">' . $file->file_name . '</a>';
                            } else {
                    ...
                    <div id="oservice-file-discussion" class="tc-content"></div>
                    </div>
                </div>
            </div>
