...
//    $date_mode = 'hijri'; //get_option('date_format');
    if ($date_mode == 'hijri') {
       ...
       $hijri_date = $hijriCalendar->GregorianToHijri($current_date['year'], $current_date['month'], $current_date['day']);
...
class Calendar
{
     ...
     * @return \hijri\Calendar hijri\Calendar object with the specified settings.
     */
