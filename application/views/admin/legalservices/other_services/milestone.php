...
<div class="modal fade" id="milestone" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('legalservices/other_services/milestone/'.$ServID),array('id'=>'milestone_form')); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_date_input('due_date','milestone_due_date','',array_merge(['data-date-min-date' => $project->start_date], ($project->deadline) ? array('data-date-end-date'=>$project->deadline) : array())); ?>                        <?php echo render_textarea('description','milestone_description'); ?>
                        <div class="checkbox">
