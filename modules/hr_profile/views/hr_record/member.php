                          ...
                          if(is_admin() || has_permission($group_item,$staffid,'view')){
                            ...
                            <li<?php if($group_item == $group){echo " class='active'"; } ?>>
                                <a href="<?php echo admin_url('hr_profile/member/'.$staffid.'/'.$group_item); ?>" data-group="<?php echo html_entity_decode($group_item); ?>">
                                    ...
                                    }elseif($group_item == 'Immigration'){
                                        echo html_entity_decode($icon[$group_item] .' '. _l($group_item));
                                    }elseif($group_item == 'bank_account'){
                                        echo html_entity_decode($icon[$group_item] .' '. _l($group_item));
                                    }elseif($group_item == 'emergency_contacts'){
                                        echo html_entity_decode($icon[$group_item] .' '. _l($group_item));
                                    }elseif($group_item == 'work_experience'){
                                        echo html_entity_decode($icon[$group_item] .' '. _l($group_item));
                                    }elseif($group_item == 'document'){
                                        echo html_entity_decode($icon[$group_item] .' '. _l($group_item));
                                    }elseif($group_item == 'qualification'){
                                        echo html_entity_decode($icon[$group_item] .' '. _l($group_item));
