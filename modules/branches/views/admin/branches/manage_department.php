            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    ...
                    <?php $columns=[];
                        ...
                        ?>
                        <?php render_datatable($columns,'departments'); ?>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="department" tabindex="-1" role="dialog">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php if($this->app_modules->is_active('branches')){?>
                            <?php $value = (isset($branch) ? $branch->branch_id : ''); ?>
                        ...
                        <?php echo render_select('branch_id',(isset($branches)?$branches:[]),['key','value'],'Branch Name'); ?>
    ...
    <script>
        ...
        function edit_department(invoker,id){
            ...
            $('#branch_id').val($(invoker).data('branch_id')).change();
