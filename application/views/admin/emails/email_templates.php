                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <?php hooks()->do_action('before_regular_duration_email_templates'); ?>
                            <div class="col-md-12">
                                <h4 class="bold well email-template-heading">
                                    <?php echo _l('email_template_regular_duration_fields_heading'); ?>
                                    <?php if($hasPermissionEdit){ ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <?php foreach(regular_duration as $regular_template){ ?>
                                            <tr>
                                                <td class="<?php if($regular_template['active'] == 0){echo 'text-throught';} ?>">
                                                    <a href="<?php echo admin_url('emails/email_template/'.$regular_template['emailtemplateid']); ?>"><?php echo $regular_template['name']; ?></a>
                                                    <?php if(ENVIRONMENT !== 'production'){ ?>
                                                        <br/><small><?php echo $regular_template['slug']; ?></small>
                                                    <?php } ?>
                                                    <?php if($hasPermissionEdit){ ?>
                                                        <a href="<?php echo admin_url('emails/'.($regular_template['active'] == '1' ? 'disable/' : 'enable/').$regular_template['emailtemplateid']); ?>" class="pull-right"><small><?php echo _l($regular_template['active'] == 1 ? 'disable' : 'enable'); ?></small></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
