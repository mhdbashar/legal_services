			...
			<div class="col-md-12">
				...
				<div class="panel_s">
					<div class="panel-body">
						...
						<div class="_buttons">
							<a href="<?php echo admin_url('staff/member'); ?>" class="btn btn-info pull-left display-block"><?php echo _l('new_employee'); ?></a>
						</div>
...
<script>
	$(function(){
		initDataTable('.table-employees', window.location.href);
	});
