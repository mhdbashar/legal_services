         ...
         <div class="col-md-12">
            <div class="row">
               <div class="col-md-9">
                  <h3 class="bold pull-left">
                     <?php if ($project->settings->edit_sessions == 1 && $view_task->is_added_from_contact == 1 && $view_task->addedfrom == get_contact_user_id()) { ?>
                        <a href="<?php echo site_url('clients/legal_services/' . $project->id . '/' . $ServID . '?group=edit_session&session_id=' . $view_task->id); ?>">
                           <i class="fa fa-pencil-square-o"></i>
                        </a>
                     <?php } ?> <?php echo $view_task->name; ?>
                  </h3>
                  <div class="clearfix"></div>
                  <div class="text-success task-info pull-left mright10">
            ...
            <?php if ($project->settings->view_task_checklist_items == 1) { ?>
               <?php if (count($view_task->checklist_items) > 0) { ?>
                  <hr />
                  <h4 class="bold mbot15"><?php echo _l('session_checklist_items'); ?></h4>
               <?php } ?>
            ...
            <?php if ($project->settings->view_session_comments == 1) { ?>
               ...
               <?php
               if ($project->settings->comment_on_sessions == 1) {
