...
<div class="row master mtop25">
    ...
    <div class="card">
        <a href="<?php echo admin_url("LegalServices/legal_procedures/delete_procedure/".$proc['id']); ?>" class="text-danger _delete pull-right" data-toggle="tooltip" title="<?php echo _l('delete'); ?>"><i class="fa fa-trash"></i></a>
        <a href="<?php echo admin_url("LegalServices/legal_procedures/contract/".$proc['reference_id']); ?>" data-toggle="tooltip" title="<?php echo _l('view'); ?>">
