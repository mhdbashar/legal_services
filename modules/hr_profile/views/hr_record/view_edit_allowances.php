						...
						<div class="panel_s">
							<div class="panel-body">
								...
								<h4 class="modal-title pl-3">
									<span class="edit-title"><?php echo _l('hr_allowances'); ?></span>
								</h4>
														...
														<table class="table border table-striped table-margintop">
															<tbody>
																<tr class="project-overview">
																	...
																	<td><?php echo html_entity_decode($allowances->id) ; ?></td>
																</tr>
																<tr class="project-overview">
																	<td class="bold"><?php echo _l('tax'); ?></td>
																	<td><?php echo html_entity_decode($allowances->tax) ; ?></td>
																</tr>
																<tr class="project-overview">
																	<td class="bold"><?php echo _l('title'); ?></td>
                                                                    <td><?php echo html_entity_decode($allowances->title) ; ?></td>
                                                                </tr>
																<tr class="project-overview">
																	<td class="bold"><?php echo _l('amount'); ?></td>
                                                                    <td><?php echo html_entity_decode($allowances->amount) ; ?></td>
                                                                </tr>
