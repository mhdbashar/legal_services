...
<body class="ticket_form<?php echo ($this->input->get('styled') === '1' ? ' styled' : ''); ?>"<?php if (is_rtl(true)) {
    echo ' dir="rtl"';
} ?>>
<div class="container-fluid">
    <div class="row">
        <div class="<?php if($this->input->get('col')){echo $this->input->get('col');} else {echo $this->input->get('styled') === '1' ? 'col-md-6 col-md-offset-3' : 'col-md-12';} ?> form-col">
            ...
            <?php } ?>
            <div id="response"></div>
            <?php echo form_open(current_full_url(),array('id'=>'ticketForm','class'=>'disable-on-submit')); ?>
