        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if(!$this->other->timers_started_for_project($slug, $project_id,array('billable'=>1,'billed'=>0,'startdate <='=>date('Y-m-d')))){ ?>
                            <div class="row">
                                <div class="col-md-10">
                        ...
                        <?php } else { $timers_started = true; ?>
                            ...
                            <div class="col-md-6 text-center">
                                <a href="#" onclick="mass_stop_timers(true, <?php echo $ServID; ?>);return false;" class="btn btn-default"><?php echo _l('invoice_project_stop_billable_timers_only'); ?></a>
                            </div>
                            <div class="col-md-6 text-center">
                                <a href="#" onclick="mass_stop_timers(false,<?php echo $ServID; ?>);return false;" class="btn btn-danger"><?php echo _l('invoice_project_stop_all_timers'); ?></a>
                            </div>
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <?php if(!isset($timers_started)){ ?>
                    <button type="submit" class="btn btn-info" onclick="invoice_oservice(<?php echo $ServID; ?>, <?php echo $project_id; ?>)"><?php echo _l('invoice_project'); ?></button>
                <?php } ?>
            </div>
        </div>
        <!-- /.modal-content -->
