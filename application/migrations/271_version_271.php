...
class Migration_Version_271 extends CI_Migration
{
      ...
      public function up()
      {
        ...
        ");
            ...
            // Add new table tblcasediscussioncomments
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblcasediscussioncomments` (
          `id` int(11) NOT NULL,
          ...
          `file_mime_type` varchar(70) DEFAULT NULL
            ...
            $this->db->query("ALTER TABLE `tblcasediscussioncomments`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblcasediscussions
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblcasediscussions` (
  `id` int(11) NOT NULL,
...
");
            ...
            // Add new table tblcase_activity
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblcase_activity` (
  `id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL,
  `staff_id` int(11) NOT NULL DEFAULT '0',
  `contact_id` int(11) NOT NULL DEFAULT '0',
  ...
  `dateadded` datetime NOT NULL
            ...
            $this->db->query("ALTER TABLE `tblcase_activity`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblcase_activity
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblcase_files` (
  `id` int(11) NOT NULL,
  ...
  `thumbnail_link` text
            ...
            $this->db->query("ALTER TABLE `tblcase_files`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblcase_movement
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblcase_movement` (
  `id` int(11) NOT NULL,
...
");
            ...
            // Add new table tblcase_notes
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblcase_notes` (
  `id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL,
  `content` text NOT NULL,
  `staff_id` int(11) NOT NULL
            ...
            $this->db->query("ALTER TABLE `tblcase_notes`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblcase_settings
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblcase_settings` (
  `id` int(11) NOT NULL,
  `case_id` int(11) NOT NULL,
...
");
            ...
            // Add new table tblcategory_types
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblcategory_types` (
  `id` int(11) NOT NULL,
  `type` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;");

            // insert default value table tblcategory_types
            $this->db->query("INSERT INTO `tblcategory_types` (`id`, `type`) VALUES
(1, 'خدمة قانونية'),
(2, 'اجراء قانوني');");
            $this->db->query("ALTER TABLE `tblcategory_types`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblcities
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblcities` (
  `Id` int(11) NOT NULL,
  ...
  `Country_id` int(11) NOT NULL
            ...
            // insert default value table tblcities
...
(457, 'Zallaq', 'الزلاق', 18);");
            ...
            $this->db->query("ALTER TABLE `tblcities`
  ADD PRIMARY KEY (`Id`);");
...
(250, 'ZW', 'Zimbabwe', '', 'Republic of Zimbabwe', 'ZWE', '716', 'yes', '263', '.zw');");
  ...
  `datecreated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
            ...
            $this->db->query("ALTER TABLE `tblirac_method`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tbllegal_procedures_lists
            $this->db->query("CREATE TABLE IF NOT EXISTS `tbllegal_procedures_lists` (
  `id` int(11) NOT NULL,
  `cat_id` int(11) NOT NULL,
  `rel_id` int(11) NOT NULL,
  `rel_type` varchar(20) NOT NULL,
  `datecreated` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
            ...
            $this->db->query("ALTER TABLE `tbllegal_procedures_lists`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tbllegal_procedures
            $this->db->query("CREATE TABLE IF NOT EXISTS `tbllegal_procedures` (
  `id` int(11) NOT NULL,
...
");
            ...
            // Add new table tblmy_basic_services
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_basic_services` (
  `id` int(255) NOT NULL,
  ...
  `datecreated` datetime NOT NULL
            ...
            $this->db->query("ALTER TABLE `tblmy_basic_services`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_cases
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_cases` (
  `id` int(11) NOT NULL,
  `numbering` int(11) DEFAULT NULL,
  `code` varchar(255) NOT NULL,
  `name` varchar(191) NOT NULL,
  ...
  `deleted` int(11) NOT NULL DEFAULT '0'
            ...
            $this->db->query("ALTER TABLE `tblmy_cases`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_casestatus
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_casestatus` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `is_default` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;");

            // insert default value table tblmy_casestatus
            $this->db->query("INSERT INTO `tblmy_casestatus` (`id`, `name`, `is_default`) VALUES
(1, 'nothing_was_specified', 1);");

            $this->db->query("ALTER TABLE `tblmy_casestatus`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_cases_judges
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_cases_judges` (
  `id` int(11) NOT NULL,
...
");
            ...
            // Add new table tblmy_cases_movement_judges
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_cases_movement_judges` (
  `id` int(11) NOT NULL,
  `judge_id` int(11) NOT NULL,
...
");
            ...
            // Add new table tblmy_categories
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_categories` (
  `id` int(255) NOT NULL,
  `name` varchar(255) NOT NULL,
...
");
            ...
            // Add new table tblmy_customer_representative
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_customer_representative` (
  `id` int(11) NOT NULL,
...
(1, 'nothing_was_specified', 1);");
            ...
            $this->db->query("ALTER TABLE `tblmy_customer_representative`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_dialog_boxes
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_dialog_boxes` (
  `id` int(11) NOT NULL,
  ...
  `active` int(11) NOT NULL DEFAULT '0'
            ...
            $this->db->query("ALTER TABLE `tblmy_dialog_boxes`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_judges
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_judges` (
  `id` int(11) NOT NULL,
  `name` varchar(250) NOT NULL,
  `note` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;");

            $this->db->query("ALTER TABLE `tblmy_judges`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_members_cases
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_members_cases` (
  `id` int(11) NOT NULL,
  `staff_id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
...
");
            ...
            // Add new table tblmy_members_movement_cases
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_members_movement_cases` (
  `id` int(11) NOT NULL,
  `staff_id` int(11) NOT NULL,
  `case_mov_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
...
");
            ...
            // Add new table tblmy_cases
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_members_services` (
  `id` int(11) NOT NULL,
  `staff_id` int(11) NOT NULL,
...
");
            ...
            // Add new table tblmy_other_services
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_other_services` (
  `id` int(11) NOT NULL,
  `service_id` int(11) NOT NULL,
  `code` varchar(255) NOT NULL,
  `numbering` int(11) DEFAULT NULL,
  ...
  `deleted` int(11) NOT NULL DEFAULT '0'
            ...
            $this->db->query("ALTER TABLE `tblmy_other_services`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_phase_data
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_phase_data` (
  `id` int(11) NOT NULL,
  ...
  `is_complete` int(11) NOT NULL DEFAULT '0'
            ...
            $this->db->query("ALTER TABLE `tblmy_phase_data`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_procurationstate
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_procurationstate` (
  `id` int(11) NOT NULL,
  `procurationstate` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;");

            $this->db->query("ALTER TABLE `tblmy_procurationstate`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_procurationtype
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_procurationtype` (
  `id` int(11) NOT NULL,
  `procurationtype` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;");

            $this->db->query("ALTER TABLE `tblmy_procurationtype`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_services_tags
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_services_tags` (
  `id` int(11) NOT NULL,
  ...
  `tag` text NOT NULL
            ...
            $this->db->query("ALTER TABLE `tblmy_services_tags`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_service_phases
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_service_phases` (
  `id` int(11) NOT NULL,
  ...
  `deleted` int(1) NOT NULL DEFAULT '0'
            ...
            $this->db->query("ALTER TABLE `tblmy_service_phases`
  ADD PRIMARY KEY (`id`);");
            $this->db->query("ALTER TABLE `tblmy_service_phases`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
");

            // Add new table tblmy_sessiondiscussioncomments
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_sessiondiscussioncomments` (
  `id` int(11) NOT NULL,
  `discussion_id` int(11) NOT NULL,
  `discussion_type` varchar(10) NOT NULL,
  ...
  `file_mime_type` varchar(70) DEFAULT NULL
            ...
            $this->db->query("ALTER TABLE `tblmy_sessiondiscussioncomments`
  ADD PRIMARY KEY (`id`);");
            $this->db->query("ALTER TABLE `tblmy_sessiondiscussioncomments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
");

            // Add new table tblmy_sessiondiscussions
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_sessiondiscussions` (
  `id` int(11) NOT NULL,
  ...
  `contact_id` int(11) NOT NULL
            ...
            $this->db->query("ALTER TABLE `tblmy_sessiondiscussions`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblmy_session_info
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblmy_session_info` (
...
");
            ...
            // Add new table tbloservicediscussioncomments
            $this->db->query("CREATE TABLE IF NOT EXISTS `tbloservicediscussioncomments` (
  `id` int(11) NOT NULL,
  `discussion_id` int(11) NOT NULL,
  `discussion_type` varchar(10) NOT NULL,
  `parent` int(11) DEFAULT NULL,
  ...
  `file_mime_type` varchar(70) DEFAULT NULL
            ...
            $this->db->query("ALTER TABLE `tbloservicediscussioncomments`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tbloservicediscussions
            $this->db->query("CREATE TABLE IF NOT EXISTS `tbloservicediscussions` (
  `id` int(11) NOT NULL,
  `oservice_id` int(11) NOT NULL,
  `subject` varchar(191) NOT NULL,
  `description` text NOT NULL,
  ...
  `contact_id` int(11) NOT NULL DEFAULT '0'
            ...
            $this->db->query("ALTER TABLE `tbloservicediscussions`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tbloservice_activity
            $this->db->query("CREATE TABLE IF NOT EXISTS `tbloservice_activity` (
  `id` int(11) NOT NULL,
  `oservice_id` int(11) NOT NULL,
  `staff_id` int(11) NOT NULL DEFAULT '0',
  `contact_id` int(11) NOT NULL DEFAULT '0',
  ...
  `dateadded` datetime NOT NULL
            ...
            $this->db->query("ALTER TABLE `tbloservice_activity`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tbloservice_files
            $this->db->query("CREATE TABLE IF NOT EXISTS `tbloservice_files` (
  `id` int(11) NOT NULL,
  `file_name` varchar(191) NOT NULL,
  `subject` varchar(191) DEFAULT NULL,
  `description` text,
  ...
  `thumbnail_link` text
            ...
            $this->db->query("ALTER TABLE `tbloservice_files`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tbloservice_notes
            $this->db->query("CREATE TABLE IF NOT EXISTS `tbloservice_notes` (
  `id` int(11) NOT NULL,
  `oservice_id` int(11) NOT NULL,
  `content` text NOT NULL,
  `staff_id` int(11) NOT NULL
            ...
            $this->db->query("ALTER TABLE `tbloservice_notes`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tbloservice_settings
            $this->db->query("CREATE TABLE IF NOT EXISTS `tbloservice_settings` (
  `id` int(11) NOT NULL,
  `oservice_id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `value` text
...
");
            ...
            // Add new table tblpinned_cases
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblpinned_cases` (
  `id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL,
  `staff_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
...
");
            ...
            // Add new table tblpinned_oservices
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblpinned_oservices` (
  `id` int(11) NOT NULL,
  `oservice_id` int(11) NOT NULL,
  `staff_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
...
");
            ...
            // Add new table tblprocurations
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblprocurations` (
  `id` int(11) NOT NULL,
  `NO` varchar(255) NOT NULL,
  `start_date` date NOT NULL,
  `end_date` date NOT NULL,
  ...
  `deadline_notified` int(11) NOT NULL
            ...
            $this->db->query("ALTER TABLE `tblprocurations`
  ADD PRIMARY KEY (`id`);");
...
");
            ...
            // Add new table tblprocuration_cases
            $this->db->query("CREATE TABLE IF NOT EXISTS `tblprocuration_cases` (
  `id` int(11) NOT NULL,
  `procuration` int(11) NOT NULL,
  `_case` int(11) NOT NULL
