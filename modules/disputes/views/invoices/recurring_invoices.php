...
$aColumns = [
    ...
    '(SELECT date FROM ' . db_prefix() . 'my_project_invoices t WHERE is_recurring_from=' . db_prefix() . 'my_project_invoices.id ORDER BY id DESC LIMIT 1) as last_date', // Last Date
