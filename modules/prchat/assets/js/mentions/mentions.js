    ...
    var MentionsInput = function(settings) {
        ...
        function initTextarea() {
            ...
            if (navigator.userAgent.indexOf("MSIE 8") > -1) {
                ...
                $('body').on('input', elmInputBox, onInputBoxInput); //Bind the input event to the text area
            }
        ...
        function addMention(mention) {
            ...
            var start = currentMessage.substr(0, startCaretPosition + 1);
        ...
        function onAutoCompleteItemClick(e) {
            ...
            if (!mentioned_users.includes(mention)) {
                mentioned_users.push(mention);
            }
        ...
        function onInputBoxKeyDown(e) {
            ...
            switch (e.keyCode) {
                ...
                case KEY.TAB:
                    // Add users in array (after this is used in groups when @name and on TAB RETURN OR CLICK
                    // send to server and also array i set to empty for next try ) 
        ...
        //Hides the autoomplete and checks if mentioned_users array have an element inside if not push it
        ...
        function populateDropdown(query, results) {
            ...
            var theLengthOfResults = results.length;
            correct_bot = 0;

            correct_bot = (theLengthOfResults * -26);
            ...
            var elmDropDownList = $("<ul style='margin-top:" + correct_bot + "px;'>").appendTo(elmAutocompleteList).hide(); //Inserts a ul element to autocomplete div and hide it
            ...
            _.each(results, function(item, index) {
                ...
                var elmListItem = $(settings.templates.autocompleteListItem({
                    ...
                    'data-mention-id': utils.htmlEncode(item.id),
