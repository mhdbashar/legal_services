...
<div class="modal fade" id="update_qualification" tabindex="-1" role="dialog" aria-labelledby="update_qualification" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr/general/update_qualification'),array('id'=>'form_transout')); ?>
...
<div class="modal fade" id="add_qualification" tabindex="-1" role="dialog" aria-labelledby="add_qualification" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr/general/add_qualification'),array('id'=>'form_transout')); ?>
            <?php echo form_hidden('staff_id', $staff_id); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('hr/general/json_qualification') ?>/" + id,
            type: "POST",
            dataType: "JSON",
