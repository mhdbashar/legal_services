			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel_s">
					<div class="panel-body">
						...
						<?php echo form_open_multipart(admin_url('hr/hr_profile/add_edit_member'), array('id' => 'add_edit_member')); ?>
						<div class="modal-body">
							...
							<div class="modal-footer">
								<a href="<?php echo admin_url('hr/hr_profile/staff_infor'); ?>"  class="btn btn-default mr-2 "><?php echo _l('hr_close'); ?></a>
