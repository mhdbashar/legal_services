...
foreach ($phases as $phase):
    ...
    ?>
    <?php //if(($showing || $i == 1) || $i == count($phases)): ?>
        ...
        <div class="panel-body" <?php /*if($compleate && count($phases) != $i){ ?>style="background-color: #e1e6ec;"<?php }*/ ?>>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <?php if($custom_fields){ ?>
                    <button type="submit" class="btn btn-success"><?php echo $compleate ? _l('edit') : _l('submit'); ?></button>
                    <?php } ?>
                    <?php //if($i != 1){ ?>
                        <?php /*<button type="button" class="btn btn-primary" onclick="back_to_previous_phase(<?php echo $project->id; ?>, '<?php echo $slug_for_btn_previous1; ?>', '<?php echo $slug_for_btn_previous2; ?>')"><?php echo _l('back_to_previous_phase'); ?> <i class="fa fa-backward" aria-hidden="true"></i></button> */?>
                    <?php //} ?>
