...
<?php hooks()->do_action('header_contracthtml'); ?>
        ...
        <div class="container preview-sticky-container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php echo form_close(); ?>
                    <?php if(is_client_logged_in() && has_contact_permission('hr_contracts')){ ?>
...
<div class="row">
    <div class="col-md-8 contract-left">
        ...
        <?php hooks()->do_action('after_contract_content',$contract); ?>
    </div>
