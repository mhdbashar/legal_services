 ...
 * @category        Controller 
 */
class Service3 extends REST_Controller {
    ...
    public function data_get($id = '')
    {
        ...
        $data = $this->Api_model->get_table('Service3', $id);
    ...
    {
        $data = $this->Api_model->search('Service3', $key);
    ...
    public function data_post()
    {
            ...
            else
            {
                ...
                $output = $this->other->add(3, $insert_data);                
