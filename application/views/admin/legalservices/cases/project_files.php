...
<?php echo form_open_multipart(admin_url('legalservices/cases/upload_file/'.$ServID.'/'.$project->id),array('class'=>'dropzone','id'=>'project-files-upload')); ?>
...
<a href="#" onclick="window.location.href = '<?php echo admin_url('legalservices/cases/download_all_files/'.$ServID.'/'.$project->id); ?>'; return false;" class="table-btn hide" data-table=".table-case-files"><?php echo _l('download_all'); ?></a>
<div class="clearfix"></div>
      ...
      <tr>
        ...
        <td data-order="<?php echo $file['file_name']; ?>">
          <a href="#" onclick="view_case_file(<?php echo $file['id']; ?>,<?php echo $file['project_id']; ?>); return false;">
            <?php if(is_image(CASE_ATTACHMENTS_FOLDER .$project->id.'/'.$file['file_name']) || (!empty($file['external']) && !empty($file['thumbnail_link']))){
          ...
          <?php $total_file_comments = total_rows(db_prefix().'casediscussioncomments',array('discussion_id'=>$file['id'],'discussion_type'=>'file')); ?>
          ...
          <td data-order="<?php echo $file['visible_to_customer']; ?>">
            ...
            ?>
            <div class="onoffswitch">
              <input type="checkbox" data-switch-url="<?php echo admin_url(); ?>legalservices/cases/change_file_visibility" id="<?php echo $file['id']; ?>" data-id="<?php echo $file['id']; ?>" class="onoffswitch-checkbox" value="<?php echo $file['id']; ?>" <?php echo $checked; ?>>
         ...
         <td>
           ...
           <button type="button" data-toggle="modal" data-original-file-name="<?php echo $file['file_name']; ?>" data-filetype="<?php echo $file['filetype']; ?>" data-path="<?php echo CASE_ATTACHMENTS_FOLDER .$project->id.'/'.$file['file_name']; ?>" data-target="#send_file" class="btn btn-info btn-icon"><i class="fa fa-envelope"></i></button>
           <?php } ?>
           <?php if($file['staffid'] == get_staff_user_id() || has_permission('projects','','delete')){ ?>
           <a href="<?php echo admin_url('legalservices/cases/remove_file/'.$ServID.'/'.$project->id.'/'.$file['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
           <?php } ?>
         </td>
       </tr>
       <?php } ?>
