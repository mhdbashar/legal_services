...
class Get_lead_status extends REST_Controller {
...

    {
        ...
        if ($type == 'tag') {
            ...
            if ($info =$this->Leads_model_api->get_tags()) {
        ...
        if ($type == 'priorities') {
            ...
            # code...
             if ($info =$this->Task_model->get_task_priorities()) {
        ...
        if ($type=='staff') {
            # code...
             if ($info =$this->Task_model->get_staff()) {
                ...
                if ($info =$this->Leads_model_api->get_lead_status($type)) {
    ...
    public function data_lead_notes()
...

    {
        ...
        // $this->form_validation->set_rules('name', 'name', 'trim|required|max_length[600]', array('is_unique' => 'This %s already exists please enter another Lead Name'));
