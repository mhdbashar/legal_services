    ...
    <div class="col-md-12 mtop10">
      <?php echo form_open_multipart('', array('id' => 'session-form')); ?>
        ...
        <div class="row">
            <div class="col-md-6">
                <?php
                $value = isset($task->session_number) ? $task->session_number : ''; ?>
        ...
        <div class="row">
          <div class="col-md-6">
            <?php echo render_date_input('startdate', 'task_add_edit_start_date', _d(date('Y-m-d'))); ?>
          </div>
          <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-6" id="dept">
            <div class="form-group">
                ...
                <select class="form-control custom_select_arrow" aria-invalid="false"  name="dept" placeholder="<?php echo _l('dropdown_non_selected_tex'); ?>">
                </select>
            </div>
          </div>
          <div class="col-md-6">
