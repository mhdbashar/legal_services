...
<div class="modal fade" id="update_termination" tabindex="-1" role="dialog" aria-labelledby="update_termination" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('hr/core_hr/update_termination'),array('id'=>'form_transout')); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="termination_type" name="termination_type" placeholder="<?php echo _l('termination_type') ?>" aria-invalid="false">
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('hr/core_hr/json_termination') ?>/" + id,
            type: "POST",
            dataType: "JSON",
