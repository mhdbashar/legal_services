...
<div class="modal fade" id="update_immigration" tabindex="-1" role="dialog" aria-labelledby="update_immigration" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('hr/general/update_immigration'),array('id'=>'form_transout')); ?>
...
<div class="modal fade" id="add_immigration" tabindex="-1" role="dialog" aria-labelledby="add_immigration" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('hr/general/add_immigration'),array('id'=>'form_transout')); ?>
            <?php echo form_hidden('staff_id', $staff_id); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('hr/general/json_immigration') ?>/" + id,
            type: "POST",
            dataType: "JSON",
