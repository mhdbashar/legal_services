...
<div class="modal fade" id="discussion" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo base_url() .  form_open(('session/session_info/discussion'),array('id'=>'discussion_form', 'method' => 'get')); ?>
...
<?php defined('BASEPATH') or exit('No direct script access allowed'); ?>
<!-- Miles Stones -->
<div class="modal fade" id="edit_discussion" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo base_url() .  form_open(('session/session_info/discussion'),array('id'=>'discussion_form', 'method' => 'get')); ?>
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_textarea('description','project_discussion_description'); ?>
                        <div class="checkbox checkbox-primary">
                        <input type="checkbox" name="show_to_customer" id="show_to_customer">
                            <label for="show_to_customer"><?php echo _l('project_discussion_show_to_customer'); ?></label>
                        </div>
                    </div>
                </div>
