...
<div class="modal fade" id="update_loan" tabindex="-1" role="dialog" aria-labelledby="update_loan" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr_profile/update_loan'),array('id'=>'form_transout')); ?>
...
<div class="modal fade" id="add_loan" tabindex="-1" role="dialog" aria-labelledby="add_loan" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr_profile/add_loan'),array('id'=>'form_transout')); ?>
            <?php echo form_hidden('staff_id', $staff_id); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
...
*/
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('hr_profile/json_loan') ?>/" + id,
            type: "POST",
            dataType: "JSON",
