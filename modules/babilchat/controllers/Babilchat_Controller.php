...
class Babilchat_Controller extends AdminController
{
    ...
    public function __construct()
    {
        ...
        if (!defined('BABIL_CHAT_MODULE_NAME')) {
            show_404();
        }
    ...
    public function pusher_auth()
    {
        if ($this->input->get()) {
            ...
            if (
                ...
                if ($this->session->has_userdata('babilchat_user_before_login')) {
                    $this->session->unset_userdata('babilchat_user_before_login');
    ...
    {
        if (!$this->input->is_ajax_request()) {
            redirect('admin/babilchat/Babilchat_Controller/chat_full_view', 'refresh');
        }
    ...
    {
        $result = $this->chat_model->getUnread();
        $this->load->view('babilchat/chat_full_view', ['unreadMessages' => $result]);
    }
    ...
    public function staff_announcement()
    {
        ...
        $this->load->view('babilchat/includes/modal', $data);
    }
    ...
    public function clients_announcement_message()
    {
        ...
        $this->load->view('babilchat/includes/client_announcment_modal', $data);
    }
    ...
    public function chatGroups()
    {
        ...
        $this->load->view('babilchat/includes/groups_modal', $data);
    }
    ...
    public function addNewChatGroupMembersModal()
    {
        ...
        $this->load->view('babilchat/includes/add_modal', $data);
    }
    ...
    public function getForwardUsersData()
    {
        ...
        $this->load->view('babilchat/includes/forward_to_modal', $data);
    }
