...
<div class="row">
   ...
   <div class="col-md-12 simple-bootstrap-select mbot5">
      ...
      <select data-show-subtext="true" data-width="auto" class="selectpicker" name="total_currency" onchange="init_disputes_invoices_total();">
      ...
      <select data-none-selected-text="<?php echo date('Y'); ?>" data-width="auto" class="selectpicker" name="invoices_total_years" onchange="init_disputes_invoices_total();" multiple="true" id="invoices_total_years">
