...
ALTER TABLE fx_bugs CHANGE    `bug_description` `description` varchar(500) ;
ALTER TABLE fx_bugs CHANGE    `issue_title` `name` varchar(500) ;
ALTER TABLE fx_bugs CHANGE    `bug_status` `case_status` varchar(500) ;
ALTER TABLE fx_bugs CHANGE    `reporter` `representative` varchar(500) ;
ALTER TABLE fx_bugs CHANGE    `bug_date` `start_date` date ;
ALTER TABLE fx_bugs CHANGE    `status_id` `status` INT;
ALTER TABLE fx_bugs CHANGE    `project` `project_rate_per_hour` INT;
ALTER TABLE fx_bugs CHANGE    `bug_id` `id` INT;
ALTER TABLE fx_bugs CHANGE    `judge_id` `jud_num` INT;
...
ALTER TABLE fx_files CHANGE    `file_id` `id` INT;
ALTER TABLE fx_files CHANGE    `uploaded_by` `staffid` INT;
ALTER TABLE fx_files CHANGE    `date_posted` `dateadded` date;
...
ADD visible_to_customer varchar (500);
...
ADD attachment_key varchar (500);
...
ADD thumbnail_link varchar (500);
...
ALTER TABLE fx_users CHANGE    `id` `staffid` INT;
ALTER TABLE fx_users CHANGE    `role_id` `role` INT;
ALTER TABLE fx_users CHANGE    `activated` `active` INT;
...
ADD last_password_change varchar (500);
...
ADD new_pass_key_requested varchar (500);
...
ADD default_language varchar (500);
...
ADD media_path_slug varchar (500);
...
ADD two_factor_auth_enabled varchar (500);
...
ADD two_factor_auth_code varchar (500);
...
ADD two_factor_auth_code_requested varchar (500);
...
ADD email_signature varchar (500);
...
ADD last_email_check varchar (500);
...
ADD project_created varchar (500);
...
ADD file_number_case varchar (500);
...
ADD file_number_court varchar (500);
...
ADD contract varchar (500);


ALTER TABLE fx_bugs


ADD estimated_hours varchar (500);
...
ADD progress_from_tasks varchar (500);
...
ADD previous_case_id INT;





RENAME TABLE fx_bugs TO tblmy_cases;
RENAME TABLE fx_files TO tblfiles;
RENAME TABLE fx_users TO tblstaff;



DROP TABLE `fx_account_details`, `fx_active_group_permissions`, `fx_activities`, `fx_api_keys`, `fx_api_logs`, `fx_assign_events`, `fx_assign_projects`, `fx_assign_tasks`,  `fx_bug_comments`, `fx_bug_files`, `fx_captcha`, `fx_category`, `fx_category_type`, `fx_comments`, `fx_comment_replies`, `fx_companies`, `fx_config`, `fx_countries`, `fx_court`, `fx_currencies`, `fx_departments`, `fx_email_templates`, `fx_estimates`, `fx_estimate_items`, `fx_events`, `fx_events_timer`, `fx_event_files`, `fx_fields`, `fx_files_category`, `fx_group_permissions`, `fx_help_link`, `fx_invoices`, `fx_ipn_log`, `fx_ipn_orders`, `fx_ipn_order_items`, `fx_items`, `fx_items_saved`, `fx_judge`, `fx_languages`, `fx_location`, `fx_location_c`, `fx_login_attempts`, `fx_messages`, `fx_milestones`, `fx_payments`, `fx_payment_methods`, `fx_permissions`, `fx_priorities`, `fx_projects`, `fx_project_settings`, `fx_project_status`, `fx_project_timer`, `fx_roles`, `fx_saved_events`, `fx_saved_tasks`, `fx_status`, `fx_tasks`, `fx_tasks_timer`, `fx_task_files`, `fx_ticketreplies`, `fx_tickets`, `fx_un_sessions`,`fx_user_autologin`, `fx_user_groups`;
...
--
-- Host: localhost:3306
-- Generation Time: May 29, 2020 at 03:50 PM
...
(178, 'company_state', '', 1),
(179, 'email_header', '<!-- Handled by Perfex Email Builder, any way you can edit it here: http://localhost/legalserv/admin/perfex_email_builder/options -->', 1),
...
(184, 'email_footer', '<!-- Handled by Perfex Email Builder, any way you can edit it here: http://localhost/legalserv/admin/perfex_email_builder/options -->', 1),
...
(206, 'last_email_queue_retry', '1590756301', 1),
...
(495, 'auto_backup_enabled', '0', 1),
(496, 'auto_backup_every', '7', 1),
(497, 'last_auto_backup', '', 1),
(498, 'delete_backups_older_then', '0', 1),
(499, 'account_planning_enabled', '1', 1),
(500, 'old_email_header', '<!doctype html>\r\n                            <html>\r\n                            <head>\r\n                              <meta name=\"viewport\" content=\"width=device-width\" />\r\n                              <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\r\n                              <style>\r\n                                body {\r\n                                 background-color: #f6f6f6;\r\n                                 font-family: sans-serif;\r\n                                 -webkit-font-smoothing: antialiased;\r\n                                 font-size: 14px;\r\n                                 line-height: 1.4;\r\n                                 margin: 0;\r\n                                 padding: 0;\r\n                                 -ms-text-size-adjust: 100%;\r\n                                 -webkit-text-size-adjust: 100%;\r\n                               }\r\n                               table {\r\n                                 border-collapse: separate;\r\n                                 mso-table-lspace: 0pt;\r\n                                 mso-table-rspace: 0pt;\r\n                                 width: 100%;\r\n                               }\r\n                               table td {\r\n                                 font-family: sans-serif;\r\n                                 font-size: 14px;\r\n                                 vertical-align: top;\r\n                               }\r\n                                   /* -------------------------------------\r\n                                     BODY & CONTAINER\r\n                                     ------------------------------------- */\r\n                                     .body {\r\n                                       background-color: #f6f6f6;\r\n                                       width: 100%;\r\n                                     }\r\n                                     /* Set a max-width, and make it display as block so it will automatically stretch to that width, but will also shrink down on a phone or something */\r\n\r\n                                     .container {\r\n                                       display: block;\r\n                                       margin: 0 auto !important;\r\n                                       /* makes it centered */\r\n                                       max-width: 680px;\r\n                                       padding: 10px;\r\n                                       width: 680px;\r\n                                     }\r\n                                     /* This should also be a block element, so that it will fill 100% of the .container */\r\n\r\n                                     .content {\r\n                                       box-sizing: border-box;\r\n                                       display: block;\r\n                                       margin: 0 auto;\r\n                                       max-width: 680px;\r\n                                       padding: 10px;\r\n                                     }\r\n                                   /* -------------------------------------\r\n                                     HEADER, FOOTER, MAIN\r\n                                     ------------------------------------- */\r\n\r\n                                     .main {\r\n                                       background: #fff;\r\n                                       border-radius: 3px;\r\n                                       width: 100%;\r\n                                     }\r\n                                     .wrapper {\r\n                                       box-sizing: border-box;\r\n                                       padding: 20px;\r\n                                     }\r\n                                     .footer {\r\n                                       clear: both;\r\n                                       padding-top: 10px;\r\n                                       text-align: center;\r\n                                       width: 100%;\r\n                                     }\r\n                                     .footer td,\r\n                                     .footer p,\r\n                                     .footer span,\r\n                                     .footer a {\r\n                                       color: #999999;\r\n                                       font-size: 12px;\r\n                                       text-align: center;\r\n                                     }\r\n                                     hr {\r\n                                       border: 0;\r\n                                       border-bottom: 1px solid #f6f6f6;\r\n                                       margin: 20px 0;\r\n                                     }\r\n                                   /* -------------------------------------\r\n                                     RESPONSIVE AND MOBILE FRIENDLY STYLES\r\n                                     ------------------------------------- */\r\n\r\n                                     @media only screen and (max-width: 620px) {\r\n                                       table[class=body] .content {\r\n                                         padding: 0 !important;\r\n                                       }\r\n                                       table[class=body] .container {\r\n                                         padding: 0 !important;\r\n                                         width: 100% !important;\r\n                                       }\r\n                                       table[class=body] .main {\r\n                                         border-left-width: 0 !important;\r\n                                         border-radius: 0 !important;\r\n                                         border-right-width: 0 !important;\r\n                                       }\r\n                                     }\r\n                                   </style>\r\n                                 </head>\r\n                                 <body class=\"\">\r\n                                  <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"body\">\r\n                                    <tr>\r\n                                     <td>&nbsp;</td>\r\n                                     <td class=\"container\">\r\n                                      <div class=\"content\">\r\n                                        <!-- START CENTERED WHITE CONTAINER -->\r\n                                        <table class=\"main\">\r\n                                          <!-- START MAIN CONTENT AREA -->\r\n                                          <tr>\r\n                                           <td class=\"wrapper\">\r\n                                            <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n                                              <tr>\r\n                                               <td>', 1),
(501, 'old_email_footer', '</td>\r\n                             </tr>\r\n                           </table>\r\n                         </td>\r\n                       </tr>\r\n                       <!-- END MAIN CONTENT AREA -->\r\n                     </table>\r\n                     <!-- START FOOTER -->\r\n                     <div class=\"footer\">\r\n                      <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n                        <tr>\r\n                          <td class=\"content-block\">\r\n                            <span>{companyname}</span>\r\n                          </td>\r\n                        </tr>\r\n                      </table>\r\n                    </div>\r\n                    <!-- END FOOTER -->\r\n                    <!-- END CENTERED WHITE CONTAINER -->\r\n                  </div>\r\n                </td>\r\n                <td>&nbsp;</td>\r\n              </tr>\r\n            </table>\r\n            </body>\r\n            </html>', 1),
(502, 'perfex_email_builder_default_media_folder', 'perfex_email_builder', 1),
(503, 'zoom_api_key', 'bbj9gNGWQb277uYIkreHRQ', 1),
(504, 'zoom_secret_key', 'SSpfEDVpEebbT6dcUPX4g1VIFKizZUBRP1Il', 1);
