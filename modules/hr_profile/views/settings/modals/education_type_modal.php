...
<div class="modal fade" id="update_type" tabindex="-1" role="dialog" aria-labelledby="update_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr_profile/update_type/education_type'),array('id'=>'form_transout', 'method'=>'get')); ?>
...
<div class="modal fade" id="add_education_type" tabindex="-1" role="dialog" aria-labelledby="add_education_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr_profile/add_type/education_type'),array('id'=>'form_transout', 'method'=>'get')); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
