                ...
                <div class="horizontal-tabs">
                    <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                        ...
                        <li role="presentation">
                            <a href="#invoice_payments_received" aria-controler="invoice_payments_received" role="tab"
                                data-toggle="tab">
                                <?php echo _l('payments'); ?> <span
                                    class="badge"><?php echo count($invoice->payments); ?></span>
                            </a>
                        </li>
                        <?php } ?>
            ...
            <div class="row mtop10">
                ...
                <div class="col-md-9 _buttons">
                    ...
                    <div class="pull-right">
                        ...
                        <a onclick="convert(this)" data-toggle="tooltip"
                            title="<?php echo _l('edit_invoice_tooltip'); ?>" class="btn btn-default btn-with-tooltip"
                            data-placement="bottom"><?php echo _l('acc_convert') ?></a>
                        <?php } ?>

                        <div class="btn-group">
                            <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><i
                                    class="fa fa-file-pdf-o"></i><?php if(is_mobile()){echo ' PDF';} ?> <span
                                    class="caret"></span></a>
                        ...
                        <span<?php if($invoice->status == Invoices_model::STATUS_CANCELLED){ ?> data-toggle="tooltip"
                            ...
                            <a href="#"
                                class="invoice-send-to-client btn-with-tooltip btn btn-default<?php if($invoice->status == Invoices_model::STATUS_CANCELLED){echo ' disabled';} ?>"
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li>
                                        ...
                                        <a
                                            href="<?php echo admin_url('invoices/send_overdue_notice/'.$invoice->id); ?>"><?php echo _l('send_overdue_notice_tooltip'); ?></a>
                                        <?php } ?>
                                    </li>
                            ...
                            <a href="#" onclick="record_payment(<?php echo $invoice->id; ?>); return false;"
                                class="mleft10 pull-right btn btn-success<?php if($invoice->status == Invoices_model::STATUS_PAID || $invoice->status == Invoices_model::STATUS_CANCELLED){echo ' disabled';} ?>">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="tab_reminders">
                    <a href="#" class="btn btn-info btn-xs" data-toggle="modal"
                        data-target=".reminder-modal-invoice-<?php echo $invoice->id; ?>"><i class="fa fa-bell-o"></i>
...
<div class="modal fade" id="convert-modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('accounting/convert/'. $invoice->id),array('id'=>'convert-form'));?>
            ...
            <div class="modal-footer">
                ...
                <button id="btn_account_history" type="submit"
                    class="btn btn-info intext-btn"><?php echo _l('submit'); ?></button>
            </div>
            <?php echo form_close(); ?>
        </div>
    </div>
