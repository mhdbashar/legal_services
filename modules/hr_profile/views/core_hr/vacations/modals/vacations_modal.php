...
<div class="modal fade" id="update_document" tabindex="-1" role="dialog" aria-labelledby="update_document" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('hr_profile/core_hr/update_document'),array('id'=>'form_transout')); ?>
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('hr_profile/core_hr/json_document') ?>/" + id,
            type: "POST",
            dataType: "JSON",
