...
<div class="modal fade invoice-project" id="invoice-project-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-xxl" role="document">
        <?php echo form_open('disputes/invoice_project/'.$project->id,array('id'=>'disputes_invoice_project_form','class'=>'_transaction_form invoice-form')); ?>
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php $this->load->view('disputes/invoices/invoice_template'); ?>
                    </div>
                </div>
            </div>
