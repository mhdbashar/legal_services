...
<ul class="nav nav-tabs no-margin" role="tablist">
    ...
    <li role="presentation" class="project_tab_files">
        <a data-group="project_files" href="<?php echo site_url('clients/legal_services/'.$project->id.'/'.$ServID.'?group=project_files'); ?>" role="tab"><i class="fa fa-files-o" aria-hidden="true"></i> <?php echo _l('project_files'); ?></a>
    </li>
    <?php } ?>
    ...
    <li role="presentation" class="project_tab_gantt">
        <a data-group="project_gantt" href="<?php echo site_url('clients/legal_services/'.$project->id.'/'.$ServID.'?group=project_gantt'); ?>" role="tab"><i class="fa fa-align-left" aria-hidden="true"></i> <?php echo _l('project_gant'); ?></a>
    </li>
    <?php } ?>
