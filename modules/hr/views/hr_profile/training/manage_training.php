...
<div id="wrapper">
	<div class="content">
							...
							<div class="horizontal-tabs mb-4">
								<ul class="nav nav-tabs nav-tabs-horizontal">
									...
									foreach($tab as $key =>  $group){
										...
										<a href="<?php echo admin_url('hr/hr_profile/training?group='.$group); ?>" data-group="<?php echo html_entity_decode($group); ?>">
											<?php 
								...
								<?php $this->load->view('hr_profile/'.$tabs['view']); ?>
		...
		<?php 
			...
			if(!(strpos($viewuri,'admin/hr/hr_profile/training?group=training_program') === false) || !(strpos($viewuri,'admin/hr/hr_profile/training') === false)){
				require('modules/hr/assets/js/training/training_program_js.php');
			}
		 ?>
	</body>
	</html>
