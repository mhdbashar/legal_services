...
class Babilchat_ClientsController extends ClientsController
{
    /**
    ...
    public function pusherCustomersAuth()
    {
        if ($this->input->get()) {
            ...
            if (
                ...
                if ($this->session->has_userdata('babilchat_client_before_login')) {
                    $this->session->unset_userdata('babilchat_client_before_login');
