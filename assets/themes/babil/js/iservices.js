function c_view_iservice_file(id, project_id) {
    $.post(site_url + 'clients/imported_service/' + id , {
        action: 'get_file',
        id: id,
...
//             __project_group = '';
//         }
//         window.location.href = admin_url + 'SImported/view/' + '/' + val + __project_group;
//     });
//
...
//         // Invoices tables
//         initDataTable(table_invoices_oservice, (admin_url + 'invoices/table_iservice/'+ clientid +'/' + slug_invoices_oservice + ($('body').hasClass('recurring') ? '?recurring=1' : '')), 'undefined', 'undefined', Invoices_Estimates_ServerParamsOservice, !$('body').hasClass('recurring') ? [
//             [3, 'desc'],
//             [0, 'desc']
...
// }
//
// function invoice_iservice(project_id) {
//     $('#pre_invoice_project_settings').modal('hide');
//     var data = {};
//
//     data.type = $('input[name="invoice_data_type"]:checked').val();
