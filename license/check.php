...
function check_license($licensekey,$localkey="") {
    $whmcsurl = "https://www.tl4t.com/";
    $licensing_secret_key = "tl4tLicensingISSUE2015"; # Unique value, should match what is set in the product configuration for MD5 Hash Verification
