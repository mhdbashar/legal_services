   ...
   if(count($pinned_oservices) > 0){ ?>
      ...
      <?php foreach($pinned_oservices as $oservice_pin){ ?>
         <li class="pinned_project">
            <a href="<?php echo admin_url('SOther/view/'.$oservice_pin['service_id'].'/'.$oservice_pin['id']); ?>" data-toggle="tooltip" data-title="<?php echo _l('pinned_project'); ?>"><?php echo $oservice_pin['name']; ?><br><small><?php echo $oservice_pin["company"]; ?></small></a>
            <div class="col-md-12">
