...
class Migration_Version_105 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->db->query("INSERT INTO `tblemailtemplates` (`type`, `slug`, `name`, `subject`, `message`, `fromname`, `fromemail`, `plaintext`, `active`, `order`) VALUES ('contract', 'contract-expiration', 'Contract Expiration', 'Contract Expiration Reminder', '', 'Babil', NULL, '0', '1', '1');");
