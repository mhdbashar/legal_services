...
<?php init_head(); ?>
<link href="<?php echo base_url('modules/clientapi/assets/main.css'); ?>" rel="stylesheet" type="text/css" />
<div id="wrapper">
   <div class="content">
      <div class="row">
         <div class="col-md-12">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                             ...
                             <a href="<?php echo admin_url('clientapi/delete_user/'.addslashes($user['id'])); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
                           </td>
                        </tr>
                        <?php } ?>
                     </tbody>
...
<div class="modal fade" id="user_api" tabindex="-1" role="dialog">
   <div class="modal-dialog">
      <?php echo form_open(admin_url('clientapi/user')); ?>
...
<?php init_tail(); ?>
<script src="<?php echo base_url('modules/clientapi/assets/main.js'); ?>"></script>