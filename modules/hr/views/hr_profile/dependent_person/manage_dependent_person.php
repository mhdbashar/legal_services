...
<div id="wrapper">
							...
							<div class="col-md-12">
								<div class="_buttons">
									<?php if(is_admin() || has_permission('hrm_dependent_person','','create')) { ?>
										...
										<a href="<?php echo admin_url('hr/hr_profile/import_xlsx_dependent_person'); ?>" class=" btn mright5 btn-default pull-left display-block">
						...
						<div class="row">
							...
							<div class="modal" id="approvaldependent" tabindex="-1" role="dialog">
								<div class="modal-dialog">
									<?php echo form_open(admin_url('hr/hr_profile/approval_status')); ?>
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	...
	<?php init_tail(); ?>
	<?php  require('modules/hr/assets/js/dependent_person/manage_js.php'); ?>
</body>
</html>
