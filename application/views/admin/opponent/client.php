   ...
   <div class="content">
      <div class="row">
         <div class="col-md-12">
            <?php /*if(isset($client) && $client->registration_confirmed == 0 && is_admin()){ ?>
               <div class="alert alert-warning">
                  ...
                  <br />
                  <a href="<?php echo admin_url('opponents/confirm_registration/'.$client->userid); ?>"><?php echo _l('confirm_registration'); ?></a>
               </div>
            <?php } else if(isset($client) && $client->active == 0 && $client->registration_confirmed == 1){ ?>
            <div class="alert alert-warning">
               <?php echo _l('opponent_inactive_message'); ?>
               <br />
         ...
         <div class="col-md-3">
            ...
            <?php $this->load->view('admin/opponent/tabs'); ?>
         </div>
         <?php } ?>
               ...
               <div class="panel-body">
                  ...
                  <div>
                     <div class="tab-content">
                           <?php $this->load->view((isset($tab) ? $tab['view'] : 'admin/opponent/groups/profile')); ?>
                     </div>
                  </div>
               </div>
            </div>
...
<?php } ?>
<?php $this->load->view('admin/opponent/client_js'); ?>
</body>
</html>
