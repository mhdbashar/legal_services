...
<?php require('modules/babilchat/assets/module_includes/mutual_and_helper_functions.php'); ?>
<?php
...
<?php } ?>
    <script>
        ...
        var users = $.get(babilchatSettings.usersList);
        ...
        var checkForNewMessages = babilchatSettings.getUnread;
        ...
        function uploadFileForm(form)
        {
            ...
            $.ajax({
                type: "POST",
                url: babilchatSettings.uploadMethod,
                data: formData,
                dataType: "json",
                processData: false,
                contentType: false,
                ...
                success: function (r) {
                    if (!r.error) {
                        ...
                        var basePath = "<?php echo base_url('modules/babilchat/uploads/'); ?>";
        ...
        /*---------------* Put babilchatSettings.debug for debug mode for Pusher *---------------*/
        ...
        var pusher = new Pusher(pusherKey, {
            authEndpoint: babilchatSettings.pusherAuthentication,
            authTransport: "jsonp",
            "cluster": appCluster,
            disableStats: true,
            auth: {
            ...
            users.then(function (data) {
                ...
                $.each(data, function (user_id, value) {
                    ...
                    if (value.staffid != presenceChannel.members.me.id) {
                        ...
                        if (value.message == undefined) value.message = babilchatSettings.sayHiText + " " + strCapitalize(value.firstname + " " + value.lastname);
        ...
        function createChatBox(obj)
        {
            ...
            if (!currentActiveChatWindow) {
                ...
                createChatBoxRequest = $.get(babilchatSettings.getMessages, {
                    from: userSessionId,
                    to: contact_id,
                    offset: 0,
                    limit: 20
        ...
        $("#frame").on("keypress", "textarea.chatbox", function (e) {
            ...
            if (e.which == 13 && !e.shiftKey) {
                ...
                $.post(babilchatSettings.serverPath, formData);
                $(this).val("");
                $(this).focus();
                scroll_event();
        ...
        {
            $.post(babilchatSettings.updateUnread, {
                id: id
            }).done(function (r) {
                if (r != "true") {
                    return false;
        ...
        {
            $.post(babilchatSettings.switchTheme, {
        ...
        {
            $.post(babilchatSettings.getSharedFiles, {
                own_id: own_id,
                contact_id: contact_id
            }).done(function (data) {
                $(".history_slider").html("");
        ...
        $("#settings").on("click", function () {
            ...
            window.location = "<?php echo admin_url('settings?group=babilchat-settings'); ?>";
            <?php else : ?>
        ...
        $(function () {
            ...
            $("body #staffAnnouncementModal").on("click touchstart", function () {
                $(".modal_container").load(babilchatSettings.chatAnnouncement, function (res) {
                    if ($(".modal-backdrop.fade").hasClass("in")) {
                        $(".modal-backdrop.fade").remove();
                    }
            ...
            $("body #clientsAnnouncementModal").on("click touchstart", function () {
                $(".modal_container").load(babilchatSettings.sendClientsAnnouncement, function (res) {
                    if ($(".modal-backdrop.fade").hasClass("in")) {
                        $(".modal-backdrop.fade").remove();
                    }
            ...
            $("#frame .dropdown .quickMentions").on("click touchstart", function () {
                $(".modal_container").load(babilchatSettings.quickMentions, function (res) {
                    if ($(".modal-backdrop.fade").hasClass("in")) {
                        $(".modal-backdrop.fade").remove();
                    }
        ...
        $("#frame .dropdown .i_groups, #frame #sidepanel #add_group_btn").on("click touchstart", function () {
            $(".modal_container").load(babilchatSettings.chatGroups, function (res) {
                if ($(".modal-backdrop.fade").hasClass("in")) {
                    $(".modal-backdrop.fade").remove();
                }
        ...
        $("#frame .message-input .wrap .search_messages").on("click", function () {
            ...
            $(".modal_container").load(babilchatSettings.searchMessagesView, {
                    id: id,
                    table: table
                },
                function (res) {
...
<?php require('modules/babilchat/assets/module_includes/groups.php'); ?>

<?php if (isClientsEnabled()) require('modules/babilchat/assets/module_includes/crm_clients.php'); ?>

    <!-- Include chat sound settings file -->
<?php require('modules/babilchat/assets/module_includes/chat_sound_settings.php'); ?>