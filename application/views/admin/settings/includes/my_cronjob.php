...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation">
        <a href="#LService_recycle_bin" aria-controls="LService_recycle_bin" role="tab"
           data-toggle="tab"><?php echo _l('LService_recycle_bin'); ?></a>
    </li>
    <li role="presentation">
        <a href="#procurations" aria-controls="procurations" role="tab"
           data-toggle="tab"><?php echo _l('procurations'); ?></a>
    </li>
    <li role="presentation">
...
<div class="tab-content">
            ...
            <div class="col-md-12">
                <?php if (!is_invoices_overdue_reminders_enabled()) { ?>
                    <div class="alert alert-warning">
                        ...
                        be sent, make sure that in <a href="<?php echo admin_url('emails'); ?>">email templates</a> the
            ...
            <div class="col-md-12">
                <?php if (!is_invoices_due_reminders_enabled()) { ?>
                    <div class="alert alert-warning">
                        ...
                        you don't need to send due notices for invoices, simply ignore this message.
                    </div>
                <?php } ?>
    ...
    <div role="tabpanel" class="tab-pane" id="estimates">
        <?php if (!is_estimates_expiry_reminders_enabled()) { ?>
            <div class="alert alert-warning">
                ...
                sent, make sure that in <a href="<?php echo admin_url('emails'); ?>">email templates</a> the expiry
                reminder email for estimates is enabled or at least you have configured <a
    ...
    <div role="tabpanel" class="tab-pane" id="proposals">
        <?php if (!is_proposals_expiry_reminders_enabled()) { ?>
            <div class="alert alert-warning">
                The system was not able to find sources to send expiry reminders, if you want expiry reminders to be
                sent, make sure that in <a href="<?php echo admin_url('emails'); ?>">email templates</a> the expiry
                reminder email for proposals is enabled or at least you have configured <a
                        href="<?php echo admin_url('settings?group=sms'); ?>">SMS</a> expiry reminder.
            </div>
        <?php } ?>
        <i class="fa fa-question-circle pull-left" data-toggle="tooltip"
    ...
    <div role="tabpanel" class="tab-pane" id="LService_recycle_bin">
