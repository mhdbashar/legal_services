...
foreach ($rResult as $aRow) {
  ...
  if($aRow['status'] == 0 || is_admin()){
      $options .= '<a id="delete-insurance" href="'. admin_url('hr_profile/delete_additional_timesheets/'.$aRow['id']).'" class="btn btn-danger btn-icon _delete mleft5"><i class="fa fa-remove"></i></a>';
  }
  $row[]   = $options;
