...
<div class="modal fade" id="update_type" tabindex="-1" role="dialog" aria-labelledby="update_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('hr_profile/Hr_profile/update_insurance_book_num'),array('id'=>'form_transout')); ?>
...
<div class="modal fade" id="add_insurance_book_num" tabindex="-1" role="dialog" aria-labelledby="add_insurance_book_num" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('hr_profile/hr_profile/add_insurance_book_num'),array('id'=>'form_transout')); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo render_input('name',_l('insurance_book_number'),'','number'); ?>
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('hr_profile/hr_profile/insurance_book_num_json') ?>/" + id,
            type: "POST",
            dataType: "JSON",
