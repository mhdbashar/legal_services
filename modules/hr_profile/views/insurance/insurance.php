...
$(function(){
    ...
    appValidateForm($('.insurance-form'),{
        ...
        health_insurance_num: {
            required: true,
            remote: {
                url: site_url + "admin/hr_profile/health_insurance_exists",
                type: 'post',
                data: {
                    insurance_id:function(){
                        return $('input[name = "insurance_id"]').val();
...
$("#insurance_book_num").change(function () {
    ...
    $("body").on('click', '.remove_insurance_history', function() {
      ...
      formData.append("insurance_history_id", insurance_history_id);
        $.ajax({ 
            url: admin_url + 'hr/delete_insurance_history',
            method: 'post', 
            data: formData, 
            contentType: false, 
            processData: false
    ...
    if(selectedOption != ''){
      ...
      formData.append("formality", selectedOption);
        $.ajax({ 
            url: admin_url + 'hr/get_hrm_formality',
            method: 'post', 
            data: formData, 
            contentType: false, 
            processData: false
    ...
    if(selectedOption != ''){
      ...
      var formData = new FormData();
        ...
        $.ajax({ 
            url: admin_url + 'hr/get_hrm_staff?staffid=' + selectedOption,
            method: 'get', 
