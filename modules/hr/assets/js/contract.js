   $(function() {
       appValidateForm($('.staff-form'), {
           ...
           contract_code: {
               required: true,
               remote: {
                url: site_url + "admin/hr/contract_code_exists",
                type: 'post',
                data: {
   ...
   $("body").on('click', '.new_wages_allowances', function() {
    ...
    $("#staff_delegate").change(function(){
      ...
      formData.append("id", $(this).children("option:selected").val());
        $.ajax({ 
            url: admin_url + 'hr/get_staff_role',
            method: 'post', 
            data: formData, 
            contentType: false, 
            processData: false
    ...
    function OnSelectionChange_salsaryform (select) {
      ...
      formData.append("id", selectedOption.value);
        $.ajax({ 
            url: admin_url + 'hr/get_staff_salary_form',
            method: 'post', 
            data: formData, 
            contentType: false, 
            processData: false
    ...
    function OnSelectionChange_allowancetype (allowancetype_value) {
      ...
      formData.append("id", selectedOption.value);
        $.ajax({ 
            url: admin_url + 'hr/get_staff_allowance_type',
            method: 'post', 
            data: formData, 
            contentType: false, 
            processData: false
