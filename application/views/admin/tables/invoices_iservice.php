...
$aColumns = [
    ...
    db_prefix() . 'my_imported_services.name as project_name',
...
$join = [
    ...
    'LEFT JOIN ' . db_prefix() . 'my_imported_services ON ' . db_prefix() . 'my_imported_services.id = ' . db_prefix() . 'invoices.rel_sid',
];
...
foreach ($rResult as $aRow) {
    ...
    $row[] = '<a href="' . admin_url('SImported/view/'. $aRow['rel_sid']) . '">' . $aRow['project_name'] . '</a>';
