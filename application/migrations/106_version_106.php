...
/*        if(!is_dir(BACKUPS_FOLDER)){
        ...
        if($theme != 'babil'){
            copy(APPPATH . 'views/themes/babil/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
