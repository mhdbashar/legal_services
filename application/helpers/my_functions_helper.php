...
hooks()->add_action('admin_init', 'my_custom_menu_items');

function my_custom_menu_items()
{
    $CI = &get_instance();

    $CI->app_menu->add_sidebar_menu_item('1', [
    ...
    $CI->app_menu->add_sidebar_children_item('1', [
