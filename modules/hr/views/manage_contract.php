...
<script>
    ...
    initDataTable(table_contract, admin_url+'hr/table_contract', undefined, undefined, ContractsServerParams,<?php echo hooks()->apply_filters('contracts_table_default_order', json_encode(array(6,'asc'))); ?>);
    ...
    load_small_table_item(id, '#hrm_contract', 'hrmcontractid', 'hrm/get_hr_contract_data_ajax', '.table-table_contract');
    }
