...
class Migration_Version_195 extends CI_Migration
{
    ...
    public function up()
    {
        if (active_clients_theme() != 'babil') {
            xcopy(VIEWPATH.'themes/babil/views/credit_note_pdf.php', VIEWPATH.'themes/'.active_clients_theme().'/views/credit_note_pdf.php');
        }
  ...
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;");
        ...
        update_option('update_info_message', '<div class="col-md-12">
            <div class="alert alert-success bold">
                <h4 class="bold">Hi! Thanks for updating Babil SYS - You are using version 1.9.5</h4>
                <p>
