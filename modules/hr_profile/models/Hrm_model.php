...
class hrm_model extends App_Model
{
    ...
    {
        $this->deleteDirectory("uploads/hr/insurances/$id");
        mkdir('uploads/hr/insurances/'.$id, 0777, true);
        $config['upload_path'] = 'uploads/hr/insurances/'.$id.'/';
    ...
    public function add_insurance($data){
        ...
        if(isset($insert_id)){
            ...
            if (!empty($_FILES['file']['name'])) {
                ...
                $this->db->where('insurance_id', $insert_id);
