        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        if(!$this->Dcase->timers_started_for_project($project_id,array('billable'=>1,'billed'=>0,'startdate <='=>date('Y-m-d')))){ ?>
                            <div class="row">
                                <div class="col-md-10">
            ...
            <div class="modal-footer">
                ...
                <?php if(!isset($timers_started)){ ?>
                    <button type="submit" class="btn btn-info" onclick="invoice_disputes(<?php echo $project_id; ?>)"><?php echo _l('invoice_project'); ?></button>
                <?php } ?>
            </div>
        </div>
        <!-- /.modal-content -->
