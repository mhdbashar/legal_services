<script>
 ...
 function training_toggle_full_view() {
  ...
  function add_training_question(type, training_id) {
      ...
      console.log(data)
      $.post(admin_url + 'hr/hr_profile/add_training_question', data).done(function(response) {
...
setTimeout(function() {
    $.post(admin_url + 'hr/hr_profile/update_training_question', data).done(function(response) {
...
function update_answer_question(question, type, questionid, answer_id) {
  ...
  setTimeout(function() {
    $.post(admin_url + 'hr/hr_profile/update_training_question_answer', data).done(function(response) {
        $(question).parents('li').find('i.question_update').removeClass('spinning');
    });
}, 10);
}
...
function remove_question_from_database(question, questionid) {
  'use strict';
  $.get(admin_url + 'hr/hr_profile/remove_question/' + questionid, function(response) {
...
function remove_box_description_from_database(question, questionboxdescriptionid) {
  'use strict';
  $.get(admin_url + 'hr/hr_profile/remove_box_description/' + questionboxdescriptionid, function(response) {
...
function add_box_description_to_database(question, questionid, boxid) {
  'use strict';
  $.get(admin_url + 'hr/hr_profile/add_box_description/' + questionid + '/' + boxid, function(response) {
...
function update_questions_order() {
  ...
  var data = {};
  data.data = update;
  $.post(admin_url + 'hr/hr_profile/update_training_questions_orders', data);
}
