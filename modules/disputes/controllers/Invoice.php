...
class Invoice extends ClientsController
{
    ...
    public function __construct()
    {
        ...
        $this->load->library(DISPUTES_MODULE_NAME . '/' . 'disputesApp');
        $this->load->helper(DISPUTES_MODULE_NAME . '/' . 'disputes_invoices');
    }
    ...
    public function index($id, $hash)
    {
        ...
        if ($this->input->post('make_payment')) {
            ...
            if (!$this->input->post('paymentmode')) {
                ...
                redirect(site_url('disputes/invoice/' . $id . '/' . $hash));
        ...
        $this->data($data);
        $this->view('invoices/invoicehtml');
