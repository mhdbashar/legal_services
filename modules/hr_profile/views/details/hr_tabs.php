                ...
                <div class="horizontal-scrollable-tabs">
					  ...
					  <div class="horizontal-tabs">
					    ...
					    <ul class="nav nav-tabs no-margin project-tabs nav-tabs-horizontal" role="tablist">
				                ...
				                <a data-group="<?php echo $general ?>" role="tab" href="<?php echo admin_url('hr_profile/member/'.$staff_id.'?group=basic_information') ?>">
				                    <i class="fa fa-th" aria-hidden="true"></i>
				                    <?php echo _l('general') ?>                                   </a>
				                            </li>
				                    <li class="project_tab_project_tasks">
				                <a data-group="<?php echo $salary ?>" role="tab" href="<?php echo admin_url('hr_profile/salary/'.$staff_id.'?group=update_salary') ?>">
