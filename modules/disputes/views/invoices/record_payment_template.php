...
<div class="col-md-12 no-padding animated fadeIn">
    <div class="panel_s">
        <?php echo form_open(admin_url('disputes/invoices/record_payment'),array('id'=>'record_payment_form')); ?>
                ...
                <div class="col-md-6">
                    ...
                    if($totalAllowed === 0) {
                        ...
                        <div class="alert alert-info">
                            ...
                            Click <a href="<?php echo admin_url('disputes/invoices/invoice/'.$invoice->id.'?allowed_payment_modes=1'); ?>">here</a> to edit the invoice and allow payment modes.
                        </div>
                        <?php
                    }
