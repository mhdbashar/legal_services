            ...
            <div class="panel_s">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <?php echo form_open(admin_url("legalservices/other_services/gantt/$ServID"), array('method' => 'get', 'id' => 'ganttFiltersForm')); ?>
                        <div class="col-md-4">
                            <select class="selectpicker" data-none-selected-text="<?php echo _l('all'); ?>"
