            ...
            <div class="col-md-6">
                <div class="panel_s">
                    ...
                    <div class="col-md-10">
                        ...
                        <?php echo render_input('userphone','Enter Phone (include the dialling code e.g +44)', $value);?>
                    </div>
...
$(document).ready(function() {
   /* $.post(admin_url+'call_logs/newToken', {forPage: window.location.pathname}, function(data) {
        let obj = JSON.parse(data);
        Twilio.Device.setup(obj.token);
    });*/
