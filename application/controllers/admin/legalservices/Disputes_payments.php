...
class Disputes_payments extends AdminController
{
    ...
    public function list_payments()
    {
        ...
        $this->load->view('admin/legalservices/disputes_cases/payments/manage', $data);
    }
    ...
    public function payment($id = '')
    {
        ...
        $payment->invoice = $this->invoices->get($payment->invoiceid);
        ...
        $data['title'] = _l('payment_receipt') . ' - ' . disputes_format_invoice_number($data['payment']->invoiceid);
        $this->load->view('admin/legalservices/disputes_cases/payments/payment', $data);
    }
