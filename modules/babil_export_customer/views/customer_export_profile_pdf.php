...
$attachment_heading = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_print_attachment_text');
$specimen_sign_heading = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_print_specimen_sign_text');
$services_heading = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_print_services_text');

$profile_width = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_logo_size');
$specimen_signatures = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_specimen_sign');
$show_shipping_address = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_show_shipping_address');
$show_billing_address = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_show_billing_address');
$print_files_separate_page = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_print_files_separate_page');
$heading_color = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_print_heading_color');
$show_primary_contact = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_show_primary_contact');
$show_groups = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_show_groups');
$show_custom_fields = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_show_custom_fields');
$show_services = get_option(BABIL_EXPORT_CUSTOMER_MODULE_NAME.'_print_services');
...
{
$html_right .=  '<b>'.ucwords(_l('babil_customer_primary_contact')).' :</b><br/>';
...
if (count($custom_fields) > 0 && $show_custom_fields){
	$html = '<style>'.file_get_contents(module_dir_url('babil_export_customer','assets/css/babil_export_customer_pdf_style.css')).'</style>';
