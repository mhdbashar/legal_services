            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <a href="#" id="new_token" onclick="new_user(); return false" class="btn btn-info pull-left display-block"><?php echo _l('new_user_api'); ?></a>
                        </div>
                            ...
                            <tbody>
                                <?php foreach ($user_api as $user) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" onclick="edit_user(this,<?php echo addslashes($user['id']); ?>); return false" data-user="<?php echo addslashes($user['user']); ?>" data-name="<?php echo addslashes($user['name']); ?>" class="btn btn-default btn-icon"><i class="fa fa-pencil-square-o"></i></a>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-info" id="submit_modal_api"><?php echo _l('submit'); ?></button>
            </div>
        </div><!-- /.modal-content -->
        <?php echo form_close(); ?>
    </div><!-- /.modal-dialog -->
...
<script>
    $(function () {
        ...
        $('#new_token').on('click', function (e) {
         
            var office_name_in_center = '<?php echo get_option('office_name_in_center'); ?>';

            if (office_name_in_center !== '') {
                $('#user_api').modal('show');
                return true;

            } else {

                alert('<?php echo _l('no_office_name_in_center') ?>');
