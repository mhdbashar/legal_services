...
/*
Module Name: كشوف الرواتب
Description: تتضمن هذه الوحدة كل ما يتعلق برواتب الموظفين وتوابعها
Version: 1.0.2
...
define('HR_PAYROLL_REVISION', 102);
...
function hr_payroll_add_head_components(){
    ...
    if (!(strpos($viewuri, '/admin/hr_payroll/import_xlsx_attendance') === false) || !(strpos($viewuri, '/admin/hr_payroll/import_xlsx_employees') === false) || !(strpos($viewuri,'admin/hr_payroll/import_xlsx_commissions') === false) || !(strpos($viewuri,'admin/hr_payroll/view_payslip_detail') === false)) {
