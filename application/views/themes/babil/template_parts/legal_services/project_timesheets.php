    ...
    <tbody>
        <?php foreach($timesheets as $timesheet){ ?>
            <tr>
                ...
                <td><a href="<?php echo site_url('clients/legal_services/'.$project->id.'/'.$ServID.'?group=project_tasks&taskid='.$timesheet['task_data']->id); ?>"><?php echo $timesheet['task_data']->name; ?></a></td>
