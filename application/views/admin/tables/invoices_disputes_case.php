...
$join = [
    ...
    'LEFT JOIN ' . db_prefix() . 'my_disputes_cases ON ' . db_prefix() . 'my_disputes_cases.id = ' . db_prefix() . 'invoices.rel_sid',
];
...
foreach ($rResult as $aRow) {
    ...
    $row[] = '<a href="' . admin_url('Disputes_cases/view/' .$ServID.'/'. $aRow['rel_sid']) . '">' . $aRow['project_name'] . '</a>';
