...
$session->duedate = $CI->app_modules->is_active('hijri') ? _d($session->duedate) . '  ||  ' . to_hijri_date(_d($session->duedate)) : _d($session->duedate);
...
<div class="panel_s mtop20">
    <div class="panel-body">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-12">
                <div class="col-md-6">
                    <p style="font-weight: bold"> <?php echo _l('رقم الدعوى') . ' :'; ?>
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-12">
                <div class="col-md-6">
                    <p style="font-weight: bold"> <?php echo _l('موضوع الجلسة') . ' :'; ?>
                        <b><?php echo $session->name; ?></b></p>
                    <p style="font-weight: bold"> <?php echo _l('نوع الجلسة') . ' :'; ?>
                        <b><?php echo _l('نوع الجلسة'); ?></b></p>
                </div>
                <div class="col-md-6">
                    <p style="font-weight: bold"> <?php echo _l('تاريخ الجلسة') . ' :'; ?>
                        <b><?php echo $session->duedate; ?></b></p>
                    <p style="font-weight: bold"> <?php echo _l('وقت الجلسة') . ' :'; ?>
                        <b><?php echo $session->time; ?></b></p>
                </div>
                <div class="col-md-12">
                    <hr class="hr-panel-heading" />
                    <p style="font-weight: bold"> <?php echo _l('وقائع الجلسة') . ' :'; ?><div class="hr-panel-heading"></div>
                    <b><?php echo $session->session_information; ?></b></p>
                </div>
                <div class="col-md-12">
                    <hr class="hr-panel-heading" />
                    <p style="font-weight: bold"> <?php echo _l('قرار المحكمة') . ' :'; ?><div class="hr-panel-heading"></div>
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-12">
                <div class="col-md-6">
                    <p style="font-weight: bold"> <?php echo _l('تاريخ الجلسة القادمة') . ' :'; ?>
                        <b><?php echo $session->next_session_date; ?></b></p>
                </div>
                <div class="col-md-6">
                    <p style="font-weight: bold"> <?php echo _l('وقت الجلسة القادمة') . ' :'; ?>
