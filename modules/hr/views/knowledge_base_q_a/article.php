  ...
  <div class="row">
   <div class="col-md-8 col-md-offset-2">
     ...
     <div class="panel-body">
      <h4 class="no-margin">
       ...
       <small>
        ...
        <a href="<?php echo admin_url('hr/knowledge_base_q_a/view/'.$article->slug); ?>" target="_blank"><?php echo admin_url('hr/knowledge_base_q_a/view/'.$article->slug); ?></a>
        <?php } else { ?>
    ...
    <p>
     ...
     <a href="<?php echo admin_url('hr/knowledge_base_q_a/article'); ?>" class="btn btn-success pull-right"><?php echo _l('kb_article_new_article'); ?></a>
     <?php } ?>
     <?php if(has_permission('hr_manage_q_a','','delete')){ ?>
     <a href="<?php echo admin_url('hr/knowledge_base_q_a/delete_article/'.$article->articleid); ?>" class="btn btn-danger _delete pull-right mright5"><?php echo _l('delete'); ?></a>
     <?php } ?>
   ...
   <?php if(has_permission('hr_manage_q_a','','create')){
     echo render_select_with_input_group('articlegroup',hr_get_kb_groups(),array('groupid','name'),'kb_article_add_edit_group',$value,'<a href="#" onclick="new_kb_group();return false;"><i class="fa fa-plus"></i></a>');
   } else {
    echo render_select('articlegroup',hr_get_kb_groups(),array('groupid','name'),'kb_article_add_edit_group',$value);
  }
  ?>
       ...
       <div id="contract_attachments" class="mtop30 col-md-8 ">
        <?php if(count($attachments) > 0){ ?>
         ...
         foreach($attachments as $attachment) {
          $href_url = site_url('modules/hr/uploads/q_a/'.$attachment['rel_id'].'/'.$attachment['file_name']).'" download';
...
<div class="text-right">
  <a href="<?php echo admin_url('hr/knowledge_base_q_a'); ?>"  class="btn btn-default  mright10">
                <?php echo _l('go_back'); ?>
              </a>
...
<?php init_tail(); ?>
<?php  require('modules/hr/assets/js/knowledge_base_q_a/article_js.php'); ?>
