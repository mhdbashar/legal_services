...
<?php
    ...
    $this->load->view('admin/LegalServices/cases/project_discussion');
...
<p><?php echo _l('project_discussion_total_comments'); ?>: <?php echo total_rows(db_prefix().'casediscussioncomments',array('discussion_id'=>$discussion->id)); ?>
