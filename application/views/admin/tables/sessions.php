...
$result = data_tables_init(
    ...
    [
        ...
        'rel_id',
        'recurring',
        sessions_rel_name_select_query() . ' as rel_name',
        'billed',
...
foreach ($rResult as $aRow) {
    ...
    $row[] = '<a href="' . admin_url('tasks/view/' . $aRow['id']) . '" onclick="init_session_modal(' . $aRow['id'] . '); return false;">' . $aRow['id'] . '</a>';
    ...
    if ($aRow['recurring'] == 1) {
        $outputName .= '<br /><span class="label label-primary inline-block mtop4"> ' . _l('recurring_session') . '</span>';
    }
