...
<div id="invoice-preview">
    <div class="row text-aligh-right">
        ...
        if($invoice->recurring > 0 || $invoice->is_recurring_from != NULL) {
            ...
            ?>
        <div class="col-md-12 text-aligh-right">
        ...
        <?php } ?>
        <div class="col-md-6 col-sm-6 text-aligh-right">
            ...
            <div class="col-sm-6 text-aligh-right fc-direction-rtl">
                <address>
    ...
    <div class="row text-aligh-right">
        <div class="col-md-12 text-aligh-right">
            <div class="table-responsive text-aligh-right">
                <?php
        ...
        <div class="col-md-5 col-md-offset-7 text-aligh-right">
            <table class="table text-aligh-right">
                <tbody>
                    <tr id="subtotal">
                ...
                ?>
                    ...
                    <tr>
                        <td><span
                                class="<?php if($invoice->total_left_to_pay > 0){echo 'text-danger ';} ?>bold"><?php echo _l('invoice_amount_due'); ?></span>
                        </td>
                        <td>
    ...
    <div class="mbot15 row inline-block full-width" data-attachment-id="<?php echo $attachment['id']; ?>">
        ...
        <div class="col-md-4 text-aligh-right">
