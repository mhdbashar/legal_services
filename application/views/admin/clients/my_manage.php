                                ...
                                <ul class="dropdown-menu dropdown-menu-left" style="width:300px;">
                                    ...
                                    <li class="dropdown-submenu pull-left groups">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-left">
                                            ...
                                            <li><a href="#"
                                                    data-cview="customer_company_group_<?php echo $company_group['id']; ?>"
                                                    onclick="dt_custom_view('customer_company_group_<?php echo $company_group['id']; ?>','.table-clients','customer_company_group_<?php echo $company_group['id']; ?>'); return false;"><?php echo $company_group['name']; ?></a>
                                            </li>
                                            <?php } ?>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown-submenu pull-left invoice">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-left">
                                            ...
                                            <li>
                                                <a href="#" data-cview="branches_<?php echo $branch["id"]; ?>"
                                                    onclick="dt_custom_view('branches_<?php echo  $branch["id"]; ?>','.table-clients','branches_<?php  $branch["id"]; ?>'); return false;"><?php echo  $branch["id"]; ?></a>
                                            </li>
                                            <?php } ?>
                                        </ul>
                                    </li>
                     ...
                     ?>
                        ...
                        <div class="row mbot15">
                            ...
                            <div class="col-md-2 col-xs-6 border-right">
                                <h3 class="bold">
                                    <?php echo total_rows(db_prefix().'clients',($where_summary != '' ? substr($where_summary,5) : ' client_type = 0')); ?>
                                </h3>
                                <span class="text-dark"><?php echo _l('customers_summary_total'); ?></span>
                            </div>
                            <div class="col-md-2 col-xs-6 border-right">
                                <h3 class="bold">
                                    <?php echo total_rows(db_prefix().'clients','active=1 AND client_type = 0'.$where_summary); ?>
                                </h3>
                                <span class="text-success"><?php echo _l('active_customers'); ?></span>
                            </div>
                            <div class="col-md-2 col-xs-6 border-right">
                                <h3 class="bold">
                                    <?php echo total_rows(db_prefix().'clients','active=0 AND client_type = 0'.$where_summary); ?>
                                </h3>
                            ...
                            <div class="col-md-2 col-xs-6 border-right">
                                <?php
                               $this->db->where([db_prefix().'clients.active'=>1, 'client_type'=>0]);
                        ...
                        ?>
                            ...
                            <div class="col-md-2 col-xs-6 border-right">
                                <?php
                               $this->db->where([db_prefix().'clients.active'=>0, 'client_type'=>0]);
