                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="_buttons">
                            ...
                            <a href="<?php echo admin_url('hr_profile/insurance'); ?>" class="btn btn-info mright5 pull-left display-block"><?php echo _l('add_insurrance'); ?></a>
...
$(function(){
    ...
    initDataTable(table_insurance,admin_url + 'Hr_profile/table_insurance', undefined, undefined, ContractsServerParams);
