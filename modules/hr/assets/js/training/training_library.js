  ...
  window.addEventListener('load',function(){
    $(function(){
    	...
    	initDataTable(training_table, admin_url+'hr/hr_profile/training_libraries_table', [0], [0], TrainingProgramServerParams, [1, 'desc']);
   ...
   function training_library_delete_bulk_action(event) {
   	...
   	if (confirm_delete()) {
   		...
   		if(mass_delete == true){
   			...
   			setTimeout(function() {
   				$.post(admin_url + 'hr/hr_profile/hrm_delete_bulk_action', data).done(function() {
