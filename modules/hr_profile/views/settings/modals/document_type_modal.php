...
<div class="modal fade" id="update_type" tabindex="-1" role="dialog" aria-labelledby="update_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr_profile/update_type/document_type'),array('id'=>'form_transout', 'method'=>'get')); ?>
            
            <div class="modal-body">
                <input type="hidden" name="old" id="old" value="">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo render_input('new',_l('document_type'),'','text',['id' => 'new']); ?>
...
<div class="modal fade" id="add_document_type" tabindex="-1" role="dialog" aria-labelledby="add_document_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button group="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <?php echo form_open(admin_url('hr_profile/add_type/document_type'),array('id'=>'form_transout', 'method'=>'get')); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo render_input('nameEn',_l('document_type')); ?>
