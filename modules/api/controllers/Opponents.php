 ...
 */
class Opponents extends REST_Controller {
    ...
    public function data_get($id = '')
    {
        ...
        $data = $this->Api_model->get_table('opponents', $id);
    ...
    public function data_post()
    {
        ...
        else
        {
            ...
            $output = $this->Opponents_model->add($insert_data);
    ...
    { 
        ...
        else
        {
            // delete data
            $this->load->model('Opponents_model');
            $output = $this->Opponents_model->delete($id);
            if($output === TRUE){
                // success
                $message = array(
                'status' => TRUE,
    ...
    public function data_put($id = '')
    {
        ...
        else
        {
            ...
            // update data
            $this->load->model('Opponents_model');
            $output = $this->Opponents_model->update($update_data, $id);
            if($output > 0 && !empty($output)){
                // success
                $message = array(
                'status' => TRUE,
