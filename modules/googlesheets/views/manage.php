                ...
                <div class="panel-body">
                    <?php  if(isset($login_button)){?>
                        <div class="_buttons pull-left">
                            ...
                            <a href="<?php echo $login_button;?>" onclick="#" class="btn btn-info pull-left mright5 test display-block">login to your google account</a>
                        </div>
                    ...
                    <div class="clearfix"></div>
                        <?php  if(!isset($login_button)){?>
                            ...
                            <thead>
                                        ...
                                        <th><?php echo _l('related with'); ?></th>
                                ...
                                <?php foreach ($files as $file){?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php }else echo 'not related';?>
                                        </td>

                                        <td>
                                           <?php if($data_file > 0){?>
                                            <?php $type = $data_file['rel_type']; $id = $data_file['rel_id'];
