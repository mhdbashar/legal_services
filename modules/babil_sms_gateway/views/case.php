...
$service_slug = $this->legal->get_service_by_id(1)->row()->slug;
    ...
    <table class="table dt-table scroll-responsive table-case-files" data-order-type="desc">
        ...
        <?php foreach($messages as $message){
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo admin_url('babil_sms_gateway/delete/' . $message->id); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
                </td>
