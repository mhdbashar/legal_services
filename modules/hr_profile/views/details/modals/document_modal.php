...
<div class="modal fade" id="update_document" tabindex="-1" role="dialog" aria-labelledby="update_document" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('hr_profile/update_document'),array('id'=>'form_transout')); ?>
...
<div class="modal fade" id="add_document" tabindex="-1" role="dialog" aria-labelledby="add_document" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(admin_url('hr_profile/add_document'),array('id'=>'form_transout')); ?>
            <?php echo form_hidden('staff_id', $staff_id); ?>
            <div class="modal-body">
                <div class="row">
                	<div class="col-md-12">
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('hr_profile/json_document') ?>/" + id,
            type: "POST",
            dataType: "JSON",
