					...
					<div class="col-md-12 no-padding">
						<div class="panel_s">
							...
							<div class="panel-body">
								<h4 class="no-margin"><?php echo _l('payment_edit_for_invoice'); ?> <a href="<?php echo admin_url('disputes/invoices/list_invoices/'.$payment->invoiceid); ?>"><?php echo disputes_format_invoice_number($payment->invoice->id); ?></a></h4>
