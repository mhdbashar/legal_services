                ...
                <div class="panel_s">
                    <div class="panel-body">
                                ...
                                <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                                    <li role="presentation" class="<?php if(!isset($tab)){ echo 'active';} ?>">
                                        <a href="#registration_on_leave" aria-controls="registration_on_leave"
                                            ...
                                            <span
                                                class="glyphicon glyphicon-align-justify"></span>&nbsp;<?php echo _l('registration_on_leave'); ?>
                                        </a>
                                    </li>
                                    <?php if($data_timekeeping_form == 'timekeeping_manually'){ ?>
                                    <li role="presentation"
                                        class="<?php if(isset($tab))if($tab == 'additional_timesheets'){ echo 'active';} ?>">
                                        <a href="#additional_timesheets" aria-controls="additional_timesheets"
                                            role="tab" data-toggle="tab">
                                            <span
                                                class="glyphicon glyphicon-pencil"></span>&nbsp;<?php echo _l('additional_timesheets'); ?>
                                        </a>
                                    </li>
                                    <?php } ?>
                                    ...
                                    <li role="presentation"
                                        class="<?php if(isset($tab))if($tab == 'type_of_leave'){ echo 'active';} ?>">
                                        <a href="#type_of_leave" aria-controls="type_of_leave" role="tab"
                                            data-toggle="tab">
                                            <span
                                                class="glyphicon glyphicon-pencil"></span>&nbsp;<?php echo _l('type_of_leave'); ?>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="tab-content active">
                            <div role="tabpanel" class="tab-pane <?php if(!isset($tab)){ echo 'active';} ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select name="department_filter[]" class="selectpicker" data-width="100%"
                                            ...
                                            <option value="<?php echo html_entity_decode($dpm['departmentid']); ?>">
                                                <?php echo html_entity_decode($dpm['name']); ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
...
render_datatable($table_data,'table_registration_leave',
 ...
 array(
   ...
   'data-default-order'=>get_table_last_order('table_registration_leave'),
                            ...
                            <div role="tabpanel"
                                class="tab-pane <?php if(isset($tab))if($tab == 'additional_timesheets'){ echo 'active';} ?>"
      ...
      if(has_permission('additional_timesheets_management', '', 'view') || has_permission('additional_timesheets_management', '', 'view_own') || is_admin()) {
       ?>
                            ...
                            <div role="tabpanel"
                                class="tab-pane <?php if(isset($tab))if($tab == 'type_of_leave'){ echo 'active';} ?>"
                                id="type_of_leave">
                                                            ...
                                                            <div class="row mtop10">
                                                                <div class="col-md-6 pb-4" id="type">
                                                                    ...
                                                                    <select name="rel_type" class="selectpicker"
                                                                        ...
                                                                        <option value="1"><?php echo _l('Leave') ?>
                                                                        </option>
                                                                        <option value="2"><?php echo _l('late') ?>
                                                                        </option>
                                                                        <option value="6"><?php echo _l('early') ?>
                                                                        </option>
                                                                        <option value="3"><?php echo _l('Go_out') ?>
                                                                        </option>
                                                                        <option value="4">
                                                                            <?php echo _l('Go_on_bussiness') ?></option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6 pb-4" id="type_of_leave">
                                                                    ...
                                                                    <select name="type_of_leave" class="selectpicker"
                                                                        ...
                                                                        data-none-selected-text="<?php echo _l('none_type'); ?>">
                                                                        <option value="8">
                                                                            <?php echo _l('annual_leave') ?></option>
                                                                        <option value="2">
                                                                            <?php echo _l('maternity_leave') ?></option>
                                                                        <option value="4">
                                                                            <?php echo _l('private_work_without_pay') ?>
                                                                        </option>
                                                                        <option value="1"><?php echo _l('sick_leave') ?>
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-12 hide"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="checkbox checkbox-primary">
                                                                            ...
                                                                            <label
                                                                                for="according_to_the_plan"><?php echo _l('according_to_the_plan'); ?></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12 hide" id="advance_payment_rq">
                                                                    <div class="panel panel-warning">
                                                                        <div class="panel-heading">
                                                                            <?php echo _l('advance_payment_request'); ?>
                                                                        </div>
                                                                        <div class="panel-body">
                                                                            <div id="list_jp">
            ...
            ?>
                                                                    <div class="form-group"
                                                                        ...
                                                                        <input type="number" id="number_of_leaving_day"
                                                                            ...
                                                                            class="form-control" onblur="get_date(this)"
                                                                            step="0.5"
                                                                ...
                                                                <div class="col-md-12 mtop10" id="number_days_off_2">
                                                                    <label
                                                                        class="control-label "><?php echo _l('number_of_days_off').': '.$days_off; ?></label><br>
                                                                    <label
                                                                        class="control-label <?php if($number_day_off == 0){echo 'text-danger';} ?>"><?php echo _l('number_of_leave_days_allowed').': '.$number_day_off; ?></label>
                                                            ...
                                                            <div class=" datetime_input hide">
                                                                ...
                                                                <div class="mb-3">
                                                                    <input type="time" name="start_time_s_time"
                                                                        class="form-control mtop10 start-time"
                                                            ...
                                                            <div class="row mtop10">
                                                                <div class="col-md-12 pb-4" id="leave_">
                                                                    ...
                                                                    <select name="followers_id" id="followers_id"
                                                                        ...
                                                                        <option
                                                                            value="<?php echo html_entity_decode($s['staffid']); ?>">
...
function add_allocation(id) {
    ...
    $('#salary-allocation').append('<div><div id="allocation-' + id + '" class="row mtop15">' +
        '<div class="col-md-3">' +
        '<input min="0" max="100" type="number" placeholder="Percent %" id="allocation[' + id +
        '][percent]" name="allocation[' + id + '][percent]" class="form-control" value="100">' +
        '</div>' +
        '<div class="col-md-6">' +
        '<input min="0" data-type="days" type="number" onchange="change_allocation_days(' + id +
        ')" placeholder="Number of Days" id="allocation[' + id + '][days]" name="allocation[' + id +
        '][days]" class="form-control" value="' + days + '">' +
        '</div>' +
        '<div class="col-md-2">' +
        '<div class="row">' +
        '<div class="col-md-6">' +
