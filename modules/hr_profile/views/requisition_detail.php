              ...
              <table class="table border table-striped ">
                ...
                <div id="contract_attachments" class="mtop30">
                 ...
                 foreach($request_leave->attachments as $attachment) {
                  $href_url = site_url('modules/hr_profile/uploads/requisition_leave/'.$attachment['rel_id'].'/'.$attachment['file_name']).'" download';
...
<div class="modal fade" id="convert_expense" tabindex="-1" role="dialog">
 <div class="modal-dialog">
  <div class="modal-content">
   <?php echo form_open(admin_url('hr_profile/advance_payment_update'),array('id'=>'advance_payment_update-form','class'=>'dropzone dropzone-manual')); ?>
...
<div class="modal fade" id="expense-category-modal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <?php echo form_open(admin_url('hr_profile/add_expense_category'),array('id'=>'expense-category-form')); ?>
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<?php } ?>
<?php init_tail(); ?>
<?php require 'modules/hr_profile/assets/js/requisition_detail_js.php';?>
