...
/*
Module Name:  CRM Powerful Chat
Description: Chat Module for  CRM
...
class Prchat_Controller extends AdminController
{
    ...
    public function __construct()
    {
        ...
        if (
            ...
            echo '<h4>Tutorial: <a target="blank" href="##">See example how to setup Pusher from Perfex CRM documentation</a>';
