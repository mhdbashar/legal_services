...
<div class="modal fade" id="update_type" tabindex="-1" role="dialog" aria-labelledby="update_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr/setting/update_type/termination_type'),array('id'=>'form_transout', 'method'=>'get')); ?>
...
<div class="modal fade" id="add_relation_type" tabindex="-1" role="dialog" aria-labelledby="add_relation_type" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open(admin_url('hr/setting/add_type/termination_type'),array('id'=>'form_transout', 'method'=>'get')); ?>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
