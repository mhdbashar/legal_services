...
class Zoom extends AdminController
{
    ...
    public function index()
    {
		...
		if ($this->input->is_ajax_request()) {
                $this->app->get_table_data(module_views_path('zoom', 'zoom_list'));
            }
    ...
    function submit_meeting(){
		...
		$join_before_host   = html_purify($this->input->post('join_before_host', false));
		$host_video   = html_purify($this->input->post('host_video', false));
		$participant_video   = html_purify($this->input->post('participant_video', false));
		$mute_upon_entry= html_purify($this->input->post('mute_upon_entry', false));
		$waiting_room= html_purify($this->input->post('waiting_room', false));
        $clientid= html_purify($this->input->post('clientid', false));
