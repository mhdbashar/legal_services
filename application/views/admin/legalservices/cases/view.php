        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-7 project-heading">
                                ...
                                <div id="project_view_name" class="pull-left">
                                    <select class="selectpicker" id="project_top" data-servid="<?php echo $ServID; ?>"
                                        data-width="fit" <?php if(count($other_projects) > 6){ ?>
                                ...
                                <div class="label btn btn-danger pull-left mleft15 mtop8 p8 " href="#"
                                    onclick="linked_services(); return false;">
                                ...
                                <h4 class="mtop15">&nbsp;&nbsp;<?php echo _l('linked_case'); ?>
                                    <a href="<?php echo admin_url('Case/view/' .$ServID.'/'. $project->previous_case_id); ?>"
                                        target="_blank"><?php echo get_case_name_by_id($project->previous_case_id); ?></a>
                                </h4>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-5 text-right">
                                <a href="<?php echo admin_url('legalservices/case_movement/edit/' .$ServID.'/'. $project->id); ?>"
                                    class="btn btn-info"><?php echo _l('NewCaseMovement'); ?></a>
                                <?php if(has_permission('tasks','','create')){ ?>
                                <a href="#"
                                    onclick="new_task_from_relation(undefined,'<?php echo $service->slug; ?>',<?php echo $project->id; ?>); return false;"
                                ...
                                <a href="#"
                                    onclick="<?php echo $invoice_func; ?>(<?php echo $ServID; ?>); return false;"
                                    class="invoice-project btn btn-info<?php if(isset($project->client_data->active) && $project->client_data->active == 0){echo ' disabled';} ?>"><?php echo _l('invoice_project'); ?></a>
                                <?php } ?>
                                <?php
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right width200 project-actions">
                                        ...
                                        <li>
                                            <a
                                                href="<?php echo admin_url('legalservices/cases/pin_action/'.$project->id); ?>">
                                        ...
                                        <?php if(has_permission('projects','','create')){ ?>
                                        <li>
                                            <a href="<?php echo admin_url('legalservices/cases/export_project_data/'.$ServID.'/'.$project->id); ?>"
                                                target="_blank"><?php echo _l('export_project_data'); ?></a>
                                        </li>
                                        <?php } ?>
                                        <?php if(is_admin()){ ?>
                                        <li>
                                            <a href="<?php echo admin_url('legalservices/cases/view_project_as_client/'.$project->id .'/'.$project->clientid.'/'.$ServID); ?>"
                                                target="_blank"><?php echo _l('project_view_as_client'); ?></a>
                                        </li>
                                        <?php } ?>
                                        <?php if(has_permission('projects','','delete')){ ?>
                                        <li>
                                            <a href="<?php echo admin_url('legalservices/cases/move_to_recycle_bin/'.$ServID.'/'.$project->id); ?>"
                                                class="_delete">
                ...
                <div id="<?php echo $case_procuration['id']; ?>" class="alert alert-warning" font-medium="">
                    ...
                    <hr class="hr-10">
                    <?php echo _l('remember_that_procuration') ?>
                    <b><?php echo get_procuration_name_by_id($procuration->id); ?></b>
                    <?php echo _l('which started at') ?>
...
$(function() {
    initDataTable('.table-previous_sessions_log', admin_url +
        ...
        undefined, undefined, 'undefined', [6, 'desc']);
    initDataTable('.table-waiting_sessions_log', admin_url +
        'legalservices/sessions/table/waiting_sessions_log', undefined, undefined, 'undefined', [5, 'asc']);
...
$("body").on('click', '.services-new-task-to-milestone', function(e) {
    ...
    new_task(admin_url + 'tasks/task?rel_type=<?php echo $service->slug; ?>&rel_id=' + project_id +
