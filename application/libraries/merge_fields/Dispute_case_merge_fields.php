...
class Dispute_case_merge_fields extends App_merge_fields
{
    ...
    public function format($invoice_id, $payment_id = false)
    {
        ...
        $invoice = $this->ci->db->get(db_prefix().'my_disputes_cases_invoices')->row();
        ...
        $fields['{project_name}']    = get_disputes_case_name_by_id($invoice->project_id);
        ...
        return hooks()->apply_filters('dispute_case_merge_fields', $fields, [
        'id'      => $invoice_id,
        'invoice' => $invoice,
     ]);
    }
