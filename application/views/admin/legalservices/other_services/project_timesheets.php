        ...
        <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
            ...
            <ul class="dropdown-menu dropdown-menu-right width300">
                <?php foreach($timesheets_staff_ids as $t_staff_id){ ?>
                    <li class="active">
                        <a href="#" data-cview="staff_id_<?php echo $t_staff_id['staff_id']; ?>" onclick="dt_custom_view(<?php echo $t_staff_id['staff_id']; ?>,'.table-timesheets_oservice','staff_id_<?php echo $t_staff_id['staff_id']; ?>'); return false;"><?php echo get_staff_full_name($t_staff_id['staff_id']); ?>
                        </a>
                    </li>
                <?php } ?>
            </ul>
...
render_datatable($table_data,'timesheets_oservice', [] ,$table_attributes); ?>
