...
/*
Module Name: الخرائط الذهنية القانونية
Description: الخرائط الذهنية للخدمات القانونية
Version: 1.0.6
Author: Babil  Team
...
function mindmap_module_init_menu_items()
{
    ...
    $CI->app_menu->add_sidebar_menu_item('mindmap_menu', [
        'name' => _l('mindmap7'), // The name if the item
    ...
    if (is_admin()) {
        $CI->app_custom_tabs->add_oservice_tab('mindmap', [
            'name'                      => _l('mindmap'),
            'icon'                      => 'fa fa-map',
    ...
    $CI->app_custom_tabs->add_case_tab('mindmap', [
        'name'                      => _l('mindmap'),
        'icon'                      => 'fa fa-map',
        'view'                      => 'mindmap/admin/project_mindmap',
        'position'                  => 55,
