<?php defined('BASEPATH') or exit('No direct script access allowed'); ?>
    <script>
        (function () {
            ...
            var checkForNewClientUnreadMessages = babilchatSettings.getClientUnreadMessages;
            var myCustomers = "";
            ...
            var f = {
                ...
                updateUnreadMessages: function (id) {
                    $.post(babilchatSettings.updateClientUnread, {
                        id: id
                    });
                },
            ...
            $("body").on("keyup", "#search_clients_field", _debounce(function (e) {
                ...
                if (value.length >= 3) {
                    ...
                    if (searchInDatabase) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo site_url('babilchat/Babilchat_ClientsController/searchClients'); ?>",
                            cache: false,
                            data: data,
            ...
            $("#frame").on("keypress", "textarea.client_chatbox", function (e) {
                ...
                if (e.which == 13 && !e.shiftKey) {
                    ...
                    $.post(babilchatSettings.clientsMessagesPath, formData);
                    $(this).val("").focus();
                    scroll_event();
                } else if (!$(this).val() || ($(this).next().next().next().val() == "null" && $(this).val())) {
                    // typing event
                    $(this).next().next().next().val("true");
                    $.post(babilchatSettings.clientsMessagesPath, form.serialize());
                }
            });
            ...
            function getClientMessages(staff_id, client_id, contact)
            {
                ...
                if (createChatBoxClientRequest) {
                    ...
                    createChatBoxClientRequest = $.get(babilchatSettings.getMutualMessages, {
            ...
            $(".client_messages").on("scroll", function () {
                ...
                if (pos == 0 && clientOffsetPush >= 10) {
                    ...
                    $.get(babilchatSettings.getMutualMessages, {
            ...
            function pushDesktopOnlineNotification(contact)
            {
                return $.notify("", {
                    ...
                    "body": lang_contact + " " + contact.info.name + " " + babilchatSettings.hasComeOnlineText,
                    "requireInteraction": true,
        ...
        function fetchMoreClients(el)
        {
            ...
            $.getJSON("<?php echo site_url('babilchat/Babilchat_ClientsController/loadMoreClients'); ?>", {
        ...
        $("body").on("click", ".chat_client_messages .btn_convert_conversation_to_ticket", function (e) {
            ...
            $(".modal_container").load(babilchatSettings.convertToTicket, {
                    id: "client_" + id,
                },
                function (res) {
        ...
        function delete_chat_client_message(msg_id)
        {
            ...
            $.post(babilchatSettings.deleteClientMessage, {
                message_id: msg_id
...
if (get_option('chat_allow_staff_to_create_tickets') == 1 || is_admin() && is_staff_member()) {
    ...
    require('modules/babilchat/assets/module_includes/modal_additional_files_includes/convert_to_ticket_inc.php');
} ?>