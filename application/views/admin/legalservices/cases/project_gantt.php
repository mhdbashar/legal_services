...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group pull-right mright10">
            <select class="selectpicker" name="gantt_type" onchange="gantt_case_filter(<?php echo $ServID; ?>);">
        ...
        <div class="form-group pull-right mright10">
            <select class="selectpicker" name="gantt_task_status" onchange="gantt_case_filter(<?php echo $ServID; ?>);" data-none-selected-text="<?php echo _l('task_status'); ?>">
